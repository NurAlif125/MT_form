            ...
            <div class="form-body tabcontents">
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row"><span class="label_body">MF31D</span><span class="label"><a style="color:red;text-decoration:none">*</a>Date and Place of Expiry</span>
                            ...
                            <input type="text" name="_071_mf31d_place_of_expiry" id="_071_mf31d_place_of_expiry" maxlength="29" placeholder="Place" input_type="MF31D Date and Place of Expiry" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_071_mf31d_place_of_expiry'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF52a</span><span class="label">Issuing Bank of the Original Documentary Credit</span>
                            <select id="_080_of52a_issuing_bank_of_the_original_documentary_credit" name="_080_of52a_issuing_bank_of_the_original_documentary_credit">
                                <option value="">choose a type</option>
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_080_of52a_issuing_bank_of_the_original_documentary_credit'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (BIC)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_080_of52a_issuing_bank_of_the_original_documentary_credit'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row" id="wrap_081_of52a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_081_of52a_identifier_code" name="_081_of52a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_081_of52a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_082_of52a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_082_of52a_name_address" name="_082_of52a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_082_of52a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF50B</span><span class="label">Non-Bank Issuer of the Original Documentary Credit</span>
                            <textarea name="_090_of50b_non_bank_issuer_of_the_original_documentary_credit" id="_090_of50b_non_bank_issuer_of_the_original_documentary_credit" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_090_of50b_non_bank_issuer_of_the_original_documentary_credit'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/> 
                        ...
                        <div class="form-row"><span class="label_body">OF39A</span><span class="label">Percentage Credit Amount Tolerance</span>
                            <input type="text" name="_130_of39a_tolerance_plus" id="_130_of39a_tolerance_plus" maxlength="2" placeholder="Plus %" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_130_of39a_tolerance_plus'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                            <input type="text" name="_131_of39a_tolerance_minus" id="_131_of39a_tolerance_minus" maxlength="2" placeholder="Minus %" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_131_of39a_tolerance_minus'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">MF41A</span><span class="label"><a style="color:red;text-decoration:none">*</a>Available With ... By ...</span>
                            <select id="_150_mf41a_available_with_by" name="_150_mf41a_available_with_by" input_type="MF41A Available With ... By ..." location="Body">
                                <option value="">choose a type</option>
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_150_mf41a_available_with_by'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (BIC)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_150_mf41a_available_with_by'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        <div class="form-row" id="wrap_151_mf41a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_151_mf41a_identifier_code" name="_151_mf41a_identifier_code" maxlength="11" input_type="MF41A Available With ... By ..." location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_151_mf41a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <div class="form-row" id="wrap_152_mf41d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_152_mf41d_name_and_address" name="_152_mf41d_name_and_address" rows="3" maxlength="140" input_type="MF41A Available With ... By ..." location="Body"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_152_mf41d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">By</span>
                            <select id="_153_mf41a_by" name="_153_mf41a_by" input_type="MF41A Available With ... By ..." location="Body">
                                <option value="">choose a type</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_153_mf41a_by'}"><c:if test="${item.detail=='BY ACCEPTANCE'}"> selected="true" </c:if></c:if></c:forEach>>BY ACCEPTANCE</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_153_mf41a_by'}"><c:if test="${item.detail=='BY DEF PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY DEF PAYMENT</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_153_mf41a_by'}"><c:if test="${item.detail=='BY MIXED PYMT'}"> selected="true" </c:if></c:if></c:forEach>>BY MIXED PYMT</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_153_mf41a_by'}"><c:if test="${item.detail=='BY NEGOTIATION'}"> selected="true" </c:if></c:if></c:forEach>>BY NEGOTIATION</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_153_mf41a_by'}"><c:if test="${item.detail=='BY PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY PAYMENT</option>
                            </select>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF42A</span><span class="label">Drawee</span>
                            <select id="_170_of42a_drawee" name="_170_of42a_drawee">
                                <option value="">choose a type</option>
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_170_of42a_drawee'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (BIC)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_170_of42a_drawee'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row" id="wrap_171_of42a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_171_of42a_identifier_code" name="_171_of42a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_171_of42a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_172_of42d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_172_of42d_name_and_address" name="_172_of42d_name_and_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_172_of42d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF42M</span><span class="label">Mixed Payment Details</span>
                            <textarea name="_180_of42m_mixed_payment_details" id="_180_of42m_mixed_payment_details" rows="4" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_180_of42m_mixed_payment_details'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF42P</span><span class="label">Negotiation/Deferred Payment Details</span>
                            <textarea name="_190_of42p_negotiation_deferred_payment_details" id="_190_of42p_negotiation_deferred_payment_details" rows="4" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_190_of42p_negotiation_deferred_payment_details'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF48</span><span class="label">Period for Presentation in Days</span>
                            <input type="text" name="_340_of48_days" id="_340_of48_days" maxlength="3" placeholder="Days" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_340_of48_days'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                            <input type="text" name="_341_of48_narrative" id="_341_of48_narrative" maxlength="35" placeholder="Narrative (optional)" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_341_of48_narrative'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                            ...
                            <div class="mt-row">
                                <div class="mt-col">
                                    <select id="_360_of58a_requested_confirmation_party" name="_360_of58a_requested_confirmation_party">
                                        <option value="">choose a type</option>
                                        <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_360_of58a_requested_confirmation_party'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (BIC)</option>
                                        <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_360_of58a_requested_confirmation_party'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                                    </select>
                                </div>
                                <div class="mt-col" id="wrap_361_of58a_bic" style="display:none;">
                                    <input type="text" name="_361_of58a_bic" id="_361_of58a_bic" maxlength="11" placeholder="BIC" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_361_of58a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_362_of58a_name_address" style="display:none;">
                                    <textarea name="_362_of58a_name_address" id="_362_of58a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_362_of58a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                            </div>
                        </div>
                        <hr/>
                            ...
                            <div class="mt-row">
                                <div class="mt-col">
                                    <select id="_390_of57a_advise_through_bank" name="_390_of57a_advise_through_bank">
                                        <option value="">choose a type</option>
                                        <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_390_of57a_advise_through_bank'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (BIC)</option>
                                        <option value="B" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_390_of57a_advise_through_bank'}"><c:if test="${item.detail=='B'}"> selected="true" </c:if></c:if></c:forEach>>Option B (Location)</option>
                                        <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_390_of57a_advise_through_bank'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                                    </select>
                                </div>
                                <div class="mt-col" id="wrap_391_of57a_bic" style="display:none;">
                                    <input type="text" name="_391_of57a_bic" id="_391_of57a_bic" maxlength="11" placeholder="BIC" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_391_of57a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_392_of57a_location" style="display:none;">
                                    <input type="text" name="_392_of57a_location" id="_392_of57a_location" maxlength="35" placeholder="Location" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_392_of57a_location'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_393_of57a_name_address" style="display:none;">
                                    <textarea name="_393_of57a_name_address" id="_393_of57a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_393_of57a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                            </div>
                        </div>
                        <hr/>
