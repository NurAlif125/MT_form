                ...
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row"><span class="label_body">MF40B</span><span class="label"><a style="color:red;text-decoration:none">*</a>Form of Documentary Credit</span>
                            <select name="_020_mf40b_form_of_documentary_credit" id="_020_mf40b_form_of_documentary_credit" class="mandatory" input_type="MF40B Form of Documentary Credit" location="Body">
                                ...
                                <option value="IRREVOCABLE" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_020_mf40b_form_of_documentary_credit'}"><c:if test="${item.detail=='IRREVOCABLE'}"> selected="true" </c:if></c:if></c:forEach>>IRREVOCABLE</option>
                                <option value="IRREVOCABLE TRANSFERABLE" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_020_mf40b_form_of_documentary_credit'}"><c:if test="${item.detail=='IRREVOCABLE TRANSFERABLE'}"> selected="true" </c:if></c:if></c:forEach>>IRREVOCABLE TRANSFERABLE</option>
                            </select>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">MF31D</span><span class="label"><a style="color:red;text-decoration:none">*</a>Date and Place of Expiry</span>
                            ...
                            <input type="text" name="_081_mf31d_place_of_expiry" id="_081_mf31d_place_of_expiry" maxlength="29" placeholder="Place" input_type="MF31D Date and Place of Expiry" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_081_mf31d_place_of_expiry'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row" id="wrap_091_of52a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_091_of52a_identifier_code" name="_091_of52a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_091_of52a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_092_of52a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_092_of52a_name_address" name="_092_of52a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_092_of52a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>

                        <!-- OF50B Non-Bank Issuer -->
                        <div class="form-row"><span class="label_body">OF50B</span><span class="label">Non-Bank Issuer</span>
                            <textarea name="_100_of50b_non_bank_issuer" id="_100_of50b_non_bank_issuer" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_100_of50b_non_bank_issuer'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/> 
                        ...
                        <div id="div_110_of51a_A" style="display:none;">
                            <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                                <input type="text" name="_111_of51a_bic" id="_111_of51a_bic" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_111_of51a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                            </div>
                        </div>
                        <div id="div_110_of51a_D" style="display:none;">
                            <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                                <textarea name="_112_of51a_name_address" id="_112_of51a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_112_of51a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Account</span>
                            <input type="text" name="_130_mf59_account" id="_130_mf59_account" maxlength="34" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_130_mf59_account'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                        ...
                        <div class="form-row" id="wrap_172_mf41d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_172_mf41d_name_and_address" name="_172_mf41d_name_and_address" rows="3" maxlength="140" input_type="MF41A Available With ... By ..." location="Body"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_172_mf41d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">By</span>
                            <select id="_173_mf41a_by" name="_173_mf41a_by" class="mandatory" input_type="MF41A Available With ... By ..." location="Body">
                                <option value="">choose a type</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_173_mf41a_by'}"><c:if test="${item.detail=='BY ACCEPTANCE'}"> selected="true" </c:if></c:if></c:forEach>>BY ACCEPTANCE</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_173_mf41a_by'}"><c:if test="${item.detail=='BY DEF PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY DEF PAYMENT</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_173_mf41a_by'}"><c:if test="${item.detail=='BY MIXED PYMT'}"> selected="true" </c:if></c:if></c:forEach>>BY MIXED PYMT</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_173_mf41a_by'}"><c:if test="${item.detail=='BY NEGOTIATION'}"> selected="true" </c:if></c:if></c:forEach>>BY NEGOTIATION</option>
                                <option <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_173_mf41a_by'}"><c:if test="${item.detail=='BY PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY PAYMENT</option>
                            </select>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row" id="wrap_191_of42a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_191_of42a_identifier_code" name="_191_of42a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_191_of42a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <div class="form-row" id="wrap_192_of42d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_192_of42d_name_and_address" name="_192_of42d_name_and_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_192_of42d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF44C</span><span class="label"><a style="color:red;text-decoration:none">*</a>Latest Date of Shipment</span>
                            <input type="text" name="_280_of44c_latest_date_of_shipment" id="_280_of44c_latest_date_of_shipment" class="mandatory" input_type="OF44C Latest Date of Shipment" location="Body" maxlength="6" placeholder="YYMMDD" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_280_of44c_latest_date_of_shipment'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>

                        <!-- OF44D Shipment Period -->
                        <div class="form-row"><span class="label_body">OF44D</span><span class="label">Shipment Period</span>
                            <textarea name="_290_of44d_shipment_period" id="_290_of44d_shipment_period" rows="3" maxlength="390"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_290_of44d_shipment_period'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF45A</span><span class="label"><a style="color:red;text-decoration:none">*</a>Description of Goods and/or Services</span>
                            <textarea name="_300_of45a_description_of_goods_and_or_services" id="_300_of45a_description_of_goods_and_or_services" class="mandatory" input_type="OF45A Description of Goods and/or Services" location="Body" rows="6" maxlength="6500"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_300_of45a_description_of_goods_and_or_services'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF48</span><span class="label">Period for Presentation in Days</span>
                            ...
                            <input type="text" name="_361_of48_narrative" id="_361_of48_narrative" maxlength="35" placeholder="Narrative (optional)" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_361_of48_narrative'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF58a</span><span class="label">Requested Confirmation Party</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_381_of58a_bic" style="display:none;">
                                    <input type="text" name="_381_of58a_bic" id="_381_of58a_bic" maxlength="11" placeholder="BIC" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_381_of58a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_382_of58a_name_address" style="display:none;">
                                    <textarea name="_382_of58a_name_address" id="_382_of58a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_382_of58a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF53a</span><span class="label">Reimbursing Bank</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_391_of53a_bic" style="display:none;">
                                    <input type="text" name="_391_of53a_bic" id="_391_of53a_bic" maxlength="11" placeholder="BIC" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_391_of53a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_392_of53a_name_address" style="display:none;">
                                    <textarea name="_392_of53a_name_address" id="_392_of53a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_392_of53a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF78</span><span class="label">Instructions to the Paying/Accepting/Negotiating Bank</span>
                            <textarea name="_400_of78_instructions_to_the_paying_accepting_negotiating_bank" id="_400_of78_instructions_to_the_paying_accepting_negotiating_bank" rows="6" maxlength="780"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_400_of78_instructions_to_the_paying_accepting_negotiating_bank'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF78D</span><span class="label">Instructions from Intermediary Bank</span>
                            <textarea name="_410_of78d_instructions_from_intermediary_bank" id="_410_of78d_instructions_from_intermediary_bank" rows="6" maxlength="780"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_410_of78d_instructions_from_intermediary_bank'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF57a</span><span class="label">'Advise Through' Bank</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_421_of57a_bic" style="display:none;">
                                    <input type="text" name="_421_of57a_bic" id="_421_of57a_bic" maxlength="11" placeholder="BIC" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_421_of57a_bic'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_422_of57a_location" style="display:none;">
                                    <input type="text" name="_422_of57a_location" id="_422_of57a_location" maxlength="35" placeholder="Location" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_422_of57a_location'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_423_of57a_name_address" style="display:none;">
                                    <textarea name="_423_of57a_name_address" id="_423_of57a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_423_of57a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                            </div>
                        </div>
                        <hr/>
