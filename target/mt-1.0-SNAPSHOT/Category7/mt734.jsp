            ...
            <div class="form-body tabcontents">
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Date</span>
                            <input type="text" name="_030_mf32a_date" id="_030_mf32a_date" maxlength="6" placeholder="YYMMDD" input_type="MF32A Date and Amount of Utilisation" location="Body" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_030_mf32a_date"}'><c:out value='${item.detail}'/></c:if></c:forEach>"/>
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Currency</span>
                            <input type="text" name="_031_mf32a_currency" id="_031_mf32a_currency" maxlength="3" input_type="MF32A Date and Amount of Utilisation" location="Body" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_031_mf32a_currency"}'><c:out value='${item.detail}'/></c:if></c:forEach>"/>
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Amount</span>
                            <input type="text" name="_032_mf32a_amount" id="_032_mf32a_amount" maxlength="15" input_type="MF32A Date and Amount of Utilisation" location="Body" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_032_mf32a_amount"}'><c:out value='${item.detail}'/></c:if></c:forEach>"/>
                        </div>
                        <hr/>

                        <!-- OF73A Charges Claimed -->
                        <div class="form-row"><span class="label_body">OF73A</span><span class="label">Charges Claimed</span>
                            <textarea name="_040_of73A_charges_claimed" id="_040_of73A_charges_claimed" rows="6" maxlength="210"><c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_040_of73A_charges_claimed"}'><c:out value='${item.detail}' /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row" id="wrap_051_of33a_date" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Date</span>
                            <input type="text" id="_051_of33a_date" name="_051_of33a_date" maxlength="6" placeholder="YYMMDD" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_051_of33a_date"}'><c:out value='${item.detail}'/></c:if></c:forEach>" />
                        </div>
                        <div class="form-row" id="wrap_052_of33a_currency" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Currency</span>
                            <input type="text" id="_052_of33a_currency" name="_052_of33a_currency" maxlength="3" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_052_of33a_currency"}'><c:out value='${item.detail}'/></c:if></c:forEach>" />
                        </div>
                        <div class="form-row" id="wrap_053_of33a_amount" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Amount</span>
                            <input type="text" id="_053_of33a_amount" name="_053_of33a_amount" maxlength="15" value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_053_of33a_amount"}'><c:out value='${item.detail}'/></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row" id="wrap_063_of57a_location" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Location</span>
                            <textarea id="_063_of57a_location" name="_063_of57a_location" maxlength="35"><c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_063_of57a_location"}'><c:out value='${item.detail}'/></c:if></c:forEach></textarea>
                        </div>
                        <div class="form-row" id="wrap_064_of57a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_064_of57a_name_address" name="_064_of57a_name_address" rows="4" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName eq '_064_of57a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
