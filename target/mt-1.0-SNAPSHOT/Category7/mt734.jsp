            ...
            <div class="form-body tabcontents">
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row">
                            ...
                            <span class="label"><a style="color:red;text-decoration:none">*</a> Sender's TRN</span>
                        ...
                        <div class="form-row">
                            ...
                            <span class="label"><a style="color:red;text-decoration:none">*</a> Presenting Bank's Reference</span>
                        ...
                        <div class="form-row">
                            ...
                            <span class="label"><a style="color:red;text-decoration:none">*</a> Date and Amount of Utilisation</span>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <span class="label_body">OF73A</span>
                            <span class="label">Charges Claimed</span>
                        ...
                        <div class="form-row">
                            <span class="label_body">OF33a</span>
                            <span class="label">Total Amount Claimed</span>
                        ...
                        <div class="form-row" id="wrap_051_of33a_date" style="display:none;">
                            <span class="label_body">&nbsp;</span>
                            <span class="label">Date</span>
                        ...
                        <div class="form-row" id="wrap_052_of33a_currency" style="display:none;">
                            <span class="label_body">&nbsp;</span>
                            <span class="label">Currency</span>
                        ...
                        <div class="form-row" id="wrap_053_of33a_amount" style="display:none;">
                            <span class="label_body">&nbsp;</span>
                            <span class="label">Amount</span>
                        ...
                        <div class="form-row" id="wrap_063_of57a_location" style="display:none;">
                            <span class="label_body">&nbsp;</span>
                        ...
                        <div class="form-row" id="wrap_064_of57a_name_address" style="display:none;">
                            <span class="label_body">&nbsp;</span>
                        ...
                        <!-- MF77J Discrepancies -->
                        <div class="form-row">
                            <span class="label_body">MF77J</span>
                            <span class="label"><a style="color:red;text-decoration:none">*</a>Discrepancies</span>
                        ...
                        <div class="form-row">
                            <span class="label_body">MF77B</span>
                            <span class="label"><a style="color:red;text-decoration:none">*</a>Disposal of Documents</span>
