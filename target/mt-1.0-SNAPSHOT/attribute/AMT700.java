...
public class AMT700 {
    ...
    Logger log = Logger.getLogger(AMT700.class);

    public MT700 getAtributeMT700() {
        MT700 data = new MT700();
        Properties prop = new Properties();
        try {
            prop.load(getClass().getClassLoader().getResourceAsStream("mt700.properties"));
