...
public class MT700Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // === Ambil parameter dari mt700.jsp ===
            ...
            String applicantBankOpt      = request.getParameter("_080_of51a_applicant_bank");
            ...
            String addAmounts            = request.getParameter("_130_of39c_additional_amounts_covered");
            String availOpt              = request.getParameter("_140_mf41a_available_with_by");
            ...
            String drafts                = request.getParameter("_150_of42c_drafts_at");
            String draweeOpt             = request.getParameter("_160_of42a_drawee");
            ...
            String mixedPayment          = request.getParameter("_170_of42m_mixed_payment_details");
            String deferredPayment       = request.getParameter("_180_of42p_negotiation_deferred_payment_details");
            ...
            String placeDispatch         = request.getParameter("_210_of44a_place_taking_in_charge_dispatch_from_place_of_receipt");
            String portLoading           = request.getParameter("_220_of44e_port_of_loading_airport_of_departure");
            String portDischarge         = request.getParameter("_230_of44f_port_of_discharge_airport_of_destination");
            String placeDestination      = request.getParameter("_240_of44b_place_of_final_destination_for_transportation_to_place_of_delivery");
            String latestDate            = request.getParameter("_250_of44c_latest_date_of_shipment");
            String shipmentPeriod        = request.getParameter("_260_of44d_shipment_period");
            String descGoods             = request.getParameter("_270_of45a_description_of_goods_and_or_services");
            String docsRequired          = request.getParameter("_280_of46a_documents_required");
            String addConditions         = request.getParameter("_290_of47a_additional_conditions");
            String specialPayBenef       = request.getParameter("_300_of49g_special_payment_conditions_for_beneficiary");
            String specialPayBank        = request.getParameter("_310_of49h_special_payment_conditions_for_bank_only");
            ...
            String confirmInstr          = request.getParameter("_340_mf49_confirmation_instructions");
            String confPartyOpt          = request.getParameter("_350_of58a_requested_confirmation_party");
            ...
            String reimbOpt              = request.getParameter("_360_of53a_reimbursing_bank");
            String reimbBic              = request.getParameter("_361_of53a_bic");
            String reimbNameAddr         = request.getParameter("_362_of53a_name_address");
            String instrToBank           = request.getParameter("_370_of78_instructions_to_the_paying_accepting_negotiating_bank");
            String adviseOpt             = request.getParameter("_380_of57a_advise_through_bank");
            ...
            String senderReceiverInfo    = request.getParameter("_390_of72z_sender_to_receiver_information");
            ...
            String newId = null;
            String prefix = "MT700";
            String sqlNextId = "SELECT COALESCE(MAX(CAST(SUBSTRING(form_id FROM '[0-9]+$') AS INTEGER)),0)+1 AS next_id FROM mt.mt700_message";
            ...
            String sql = "INSERT INTO mt.mt700_message(" +
                ...
                "mf31d_date_of_expiry, mf31d_place_of_expiry, of51a_applicant_bank, of51a_bic, of51a_name_address, " +
                "mf50_applicant, mf59_account, mf59_name_address, mf32b_currency, mf32b_amount, " +
                "of39a_tolerance_plus, of39a_tolerance_minus, of39c_additional_amounts_covered, mf41a_option, mf41a_identifier_code, " +
                ...
                "of58a_requested_confirmation_party, of58a_bic, of58a_name_address, of53a_reimbursing_bank, of53a_bic, of53a_name_address, " +
                "of78_instructions, of57a_advise_through_bank, of57a_bic, of57a_location, of57a_name_address, of72z_information" +
                ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            try (Connection conn = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASS);
                ...
                out.println("<script>alert('MT700 data saved successfully!'); window.location='Category7/mt700.jsp';</script>");
