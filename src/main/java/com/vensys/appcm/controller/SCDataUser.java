...
//        String idPass="";
        ...
        if(request.getParameter("group_limit") == null || request.getParameter("group_limit").equals("")) {
            group_limit = "-1";
        } else {
            group_limit = request.getParameter("group_limit");
        }
...
//        data.setUser_mt_routing(Integer.parseInt(request.getParameter("user_mt_routing")));
        ...
        data.setSub_role(Integer.parseInt(group_limit));
...
//                System.out.println("delete");
                dbData2.disablePermanent(user_id, (String) session.getAttribute("user_id"), (String) session.getAttribute("ip_access"), (String) session.getAttribute("comp_name"));
