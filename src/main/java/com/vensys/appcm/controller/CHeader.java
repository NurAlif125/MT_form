...
import com.vensys.appcm.controller.TagMT701;
import com.vensys.appcm.controller.TagMT707;
import com.vensys.appcm.controller.TagMT708;
import com.vensys.appcm.controller.TagMT710;
import com.vensys.appcm.controller.TagMT711;
import com.vensys.appcm.controller.TagMT720;
import com.vensys.appcm.controller.TagMT730;
import com.vensys.appcm.controller.TagMT734;
...
import com.vensys.appcm.controller.TagMT767;
import com.vensys.appcm.controller.TagMT940;
import com.vensys.appcm.controller.TagMT950;
...
public class CHeader {
    ...
    Logger log = LogManager.getLogger(CHeader.class);
    TagDB tag = new TagDB();
...
//            log.info("testcheader::");
            ...
            if (messageType.equalsIgnoreCase("103")) {
            ...
            } else if (messageType.equalsIgnoreCase("199")) {
                TagMT199 mt199 = new TagMT199(this);
                mt199.tagMT199(sb4, id);
                ...
                tagMT200(sb4, id);
            } else if (messageType.equalsIgnoreCase("700")) {
                TagMT700 mt700 = new TagMT700(this);
                mt700.tagMT700(sb4, id);
            } else if (messageType.equalsIgnoreCase("940")) {
                TagMT940 mt940 = new TagMT940(this);
                mt940.tagMT940(sb4, id);
            } else if (messageType.equalsIgnoreCase("950")) {
                TagMT950 mt950 = new TagMT950(this);
                mt950.tagMT950(sb4, id);
            }
...
//                    arr_[0] = arr_[0].replaceAll("[^\\d]", "");//20200424 tambah kondisi hanya untuk 59
                    arr_[0] = arr_[0].replaceAll("/", "");//20200424 tambah kondisi hanya untuk 59
                }
                if (tagName.equalsIgnoreCase("59")) {
                    readBlock4(arr[0], tagName, "/" + arr_[0]);
                } else {
...
//            log.info("tagValue readblock4 " + tagValue);
            if (tagName.contains("15")) {
                ...
                try {
                    dBDataTransaksiOutgoing2.addDataTag(tag.getUrutan(), tag.getTag().trim(), "", tag.getTagName().trim(), this.id_headers);
                } catch (Exception ex) {
                ...
                if (!tagValue.equals("")) {
                    ...
                    try {
                        dBDataTransaksiOutgoing2.addDataTag(tag.getUrutan(), tag.getTag().trim(), tag.getDetail().trim(), tag.getTagName().trim(), this.id_headers);
                    } catch (Exception ex) {
...
//            log.info("arr_[1]:" + arr_[1]);
    ...
    public void insertJsonTags(String mt, int id) {
        ...
        String[] scopeMX = {"pacs.004", "pacs.008", "pacs.009", "pacs.002"};
        boolean checkScope = Arrays.stream(scopeMX).anyMatch(mt::contains);
