...
public class VPasswordSetting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DataPasswordSetting dataUserById = new DataPasswordSetting();
        ...
        request.setAttribute("dataUserById", dataUserById);
        RequestDispatcher view = request.getRequestDispatcher("addPassword.jsp");
