...
public class CreateText {
    ...
    public Header getHeaderById(Integer headerId) throws SQLException {
        ...
        String sql = "SELECT applicationId,serviceId,logicalTerminal,io_type,messageType,receiverAddress,messagePriority,sessionNumber,sequenceNumber,block3,senderInputTime,MIRDate,MIRLogicalTerminal,MIRSessionNumber,MIRSequenceNumber,receiverOutputDate,receiverOutputTime,mur FROM headers WHERE id_headers=" + headerId;
...
//            log.info("data : "+header.getApplicationId());
            ...
            header.setMur(rs.getString(18));    //MUR
...
//        out.write(fin.toUpperCase());
    ...
    public String createFinalMT(Header header) throws SQLException, Exception {
        ...
        String mur = header.getMur();
//        log.info("block3==" + block3);
        if (block3 != null && block3.contains(";")) {
            log.info("block3 : " + block3);
            msg.setBlock3(new SwiftBlock3());
            if (mur != null && !mur.trim().isEmpty()) {
                msg.getBlock3().append(new Tag("108", header.getMur()));
            }
...
//                            }
                        ...
                        } else if (tagDB.get(i).getTag().equalsIgnoreCase("52D1") || tagDB.get(i).getTag().equalsIgnoreCase("52D2") || tagDB.get(i).getTag().equalsIgnoreCase("56D1") || tagDB.get(i).getTag().equalsIgnoreCase("56D2") || tagDB.get(i).getTag().equalsIgnoreCase("57D1") || tagDB.get(i).getTag().equalsIgnoreCase("57D2") || tagDB.get(i).getTag().equalsIgnoreCase("52A1") || tagDB.get(i).getTag().equalsIgnoreCase("52A2") || tagDB.get(i).getTag().equalsIgnoreCase("56A1") || tagDB.get(i).getTag().equalsIgnoreCase("56A2") || tagDB.get(i).getTag().equalsIgnoreCase("57A1") || tagDB.get(i).getTag().equalsIgnoreCase("57A2") || tagDB.get(i).getTag().equalsIgnoreCase("57B1") || tagDB.get(i).getTag().equalsIgnoreCase("57B2")) {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase().substring(0, 3), str.get(0)));
                        }
                        ...
                        } else if (tagDB.get(i).getTag().equalsIgnoreCase("52D1") || tagDB.get(i).getTag().equalsIgnoreCase("52D2") || tagDB.get(i).getTag().equalsIgnoreCase("56D1") || tagDB.get(i).getTag().equalsIgnoreCase("56D2") || tagDB.get(i).getTag().equalsIgnoreCase("57D1") || tagDB.get(i).getTag().equalsIgnoreCase("57D2")) {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase().substring(0, 3), str.get(0) + "\r\n" + wrapString(str.get(1), 4, 35)));
                        } else if (tagDB.get(i).getTag().equalsIgnoreCase("52A1") || tagDB.get(i).getTag().equalsIgnoreCase("52A2") || tagDB.get(i).getTag().equalsIgnoreCase("56A1") || tagDB.get(i).getTag().equalsIgnoreCase("56A2") || tagDB.get(i).getTag().equalsIgnoreCase("57A1") || tagDB.get(i).getTag().equalsIgnoreCase("57A2") || tagDB.get(i).getTag().equalsIgnoreCase("57B1") || tagDB.get(i).getTag().equalsIgnoreCase("57B2")) {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase().substring(0, 3), str.get(0) + "\r\n" + str.get(1)));
                        } else {
                        ...
                        if (tagDB.get(i).getTag().equalsIgnoreCase("11S")) {
                        ...
                        if (tagDB.get(i).getTag().equalsIgnoreCase("71F")) {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase(), str.get(0) + str.get(1)));
                        } else if (tagDB.get(i).getTag().equalsIgnoreCase("60F") || tagDB.get(i).getTag().equalsIgnoreCase("60M") || tagDB.get(i).getTag().equalsIgnoreCase("62F") ||  tagDB.get(i).getTag().equalsIgnoreCase("62M") ||  tagDB.get(i).getTag().equalsIgnoreCase("64")) {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase(), str.get(0) + str.get(1) + str.get(2) + str.get(3)));
                        } else {
                            msg.getBlock4().append(new Tag(tagDB.get(i).getTag().toUpperCase(), str.get(0) + "\r\n" + str.get(1) + "\r\n" + str.get(2) + str.get(3)));
                        }
                    } else if (str.size() == 5) {
