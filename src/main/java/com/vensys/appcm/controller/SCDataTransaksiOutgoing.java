...
//            header.setTanggal_date(now);
            ...
            if (messageType.equals("103") || messageType.equals("110") || messageType.equals("111") || messageType.equals("191") || messageType.equals("192") || messageType.equals("199") || 
                    ...
                    messageType.contains("700") || messageType.contains("701") || messageType.contains("707") || messageType.contains("708") || messageType.contains("710") || messageType.contains("711") || messageType.contains("720") || messageType.contains("730") || messageType.contains("734") || messageType.contains("740") || messageType.contains("742") || messageType.contains("747") || messageType.contains("759") || messageType.contains("760") || messageType.contains("761") || messageType.contains("767") ||
