...
//                    System.out.println("MULAI DISABLE");
                    dbData2.disablePermanent(data.getRole_id(), (String) session.getAttribute("user_id"), (String) session.getAttribute("ip_access"), (String) session.getAttribute("comp_name"));
                }
            }
        }
        try {
