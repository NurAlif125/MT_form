...
public class SCGeneralSetting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        data.setMT701(request.getParameter("mt701"));
        data.setMT708(request.getParameter("mt708"));
        data.setMT710(request.getParameter("mt710"));
        data.setMT711(request.getParameter("mt711"));
        data.setMT720(request.getParameter("mt720"));
        data.setMT730(request.getParameter("mt730"));
        data.setMT734(request.getParameter("mt734"));
        ...
        data.setMT767(request.getParameter("mt767"));
