...
public class SCGeneralSetting extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DBDataGeneralSetting dbData2 = new DBDataGeneralSetting(dbConn2.getConnection2());
        ...
        data.setMT700(request.getParameter("mt701"));
        data.setMT700(request.getParameter("mt708"));
        data.setMT700(request.getParameter("mt710"));
        data.setMT700(request.getParameter("mt711"));
        data.setMT700(request.getParameter("mt720"));
        data.setMT700(request.getParameter("mt730"));
        data.setMT700(request.getParameter("mt734"));
        data.setMT700(request.getParameter("mt740"));
        data.setMT700(request.getParameter("mt742"));
        data.setMT700(request.getParameter("mt747"));
        data.setMT700(request.getParameter("mt759"));
        data.setMT700(request.getParameter("mt760"));
        data.setMT700(request.getParameter("mt761"));
        data.setMT700(request.getParameter("mt767"));
        data.setMT940(request.getParameter("mt940"));
        ...
        if (id == null || id.equals("null") || id.isEmpty()) {
            ...
            int update = dbData2.updateDataGS(data, (String) session.getAttribute("user_id"), (String) session.getAttribute("ip_access"), (String) session.getAttribute("comp_name"));
            if (update > 0) {
