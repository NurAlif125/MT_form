...
public class SCPrintXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sheet.addCell(lcurr);
            sheet.addCell(lamt);
            sheet.addCell(lsenacc);
            sheet.addCell(lsenname);
            sheet.addCell(lrecacc);
            sheet.addCell(lrecname);
            sheet.addCell(ldt);
            //penambahan kolom baru//20200511//
            sheet.addCell(lsendercountry);
            sheet.addCell(lreceivercountry);
            sheet.addCell(lsenderbank);
            sheet.addCell(lreceiverbank);
            sheet.addCell(lnostro);
            sheet.addCell(linformation);
            sheet.addCell(lcharges);
            sheet.addCell(lbranch);
            sheet.addCell(lbranchname);
            sheet.addCell(lnoft);
            sheet.addCell(lstatus);
            sheet.addCell(lkomentar);
            for (int i = 0; i < headers.size(); i++) {
                ...
                sheet.addCell(curr);
                sheet.addCell(amt);
                sheet.addCell(senacc);
                sheet.addCell(senname);
                sheet.addCell(recacc);
                sheet.addCell(recname);
                sheet.addCell(dt);
                sheet.addCell(sendercountry);
                sheet.addCell(receivercountry);
                sheet.addCell(senderbank);
                sheet.addCell(receiverbank);
                sheet.addCell(nostro);
                sheet.addCell(information);
                sheet.addCell(charges);
                sheet.addCell(sbranch);
                sheet.addCell(sbranchname);
                sheet.addCell(noft);
                sheet.addCell(status);
                sheet.addCell(komentar);
            }
//            for (int a=0; a<10;a++){
//                sheet.addCell(new Label(1, a+4, headers.get(1).toString()));
//            }
