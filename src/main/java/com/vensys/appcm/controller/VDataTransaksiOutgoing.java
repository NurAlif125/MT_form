...
//            System.out.println("Rekening:" + rekening);
        ...
        if ("103".equalsIgnoreCase(typeMT) || "110".equalsIgnoreCase(typeMT) || "111".equalsIgnoreCase(typeMT) || "191".equalsIgnoreCase(typeMT) || "192".equalsIgnoreCase(typeMT) || 
                ...
                "700".equalsIgnoreCase(typeMT) || "720".equalsIgnoreCase(typeMT) || "730".equalsIgnoreCase(typeMT) || "734".equalsIgnoreCase(typeMT) || "740".equalsIgnoreCase(typeMT) || "742".equalsIgnoreCase(typeMT) || "747".equalsIgnoreCase(typeMT) ||
...
//            System.out.println("receiverBank : "+receiverBank);
        ...
        if (headerById.getNetworktype().contains("MT")) {
            if (headerById.getMessageType().contains("103") || headerById.getMessageType().contains("110") || headerById.getMessageType().contains("111") || headerById.getMessageType().contains("191") || headerById.getMessageType().contains("192") || headerById.getMessageType().contains("199") || 
                    ...
                    headerById.getMessageType().contains("700") || headerById.getMessageType().contains("720") || headerById.getMessageType().contains("730") || headerById.getMessageType().contains("734") || headerById.getMessageType().contains("740") || headerById.getMessageType().contains("742") || headerById.getMessageType().contains("747") ||
