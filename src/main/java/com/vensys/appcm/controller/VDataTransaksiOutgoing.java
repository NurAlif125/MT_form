...
//        DBMTText dbText = new DBMTText(dbConn.getConnection());
        ...
        try {
            ...
            String dataChannel = headerById.getChannel();
            String userChannel = (String) httpSession.getAttribute("channel");

            dataChannel = dataChannel != null ? dataChannel.toUpperCase() : "";
            userChannel = userChannel != null ? userChannel.toUpperCase() : "";

            // System.out.println("============ get channel: (" + dataChannel + ") ------ session: (" + userChannel + ") ==============");
            log.info("get channel: (" + dataChannel + ") - session: (" + userChannel + ") ");
            // setting akses channel, pastikan uppercase semua
            Map<String, List<String>> accessMap = new HashMap<>();
            accessMap.put("TREASURY OPS", Arrays.asList("FRONTARENA", "TSA", "TREASURY OPS"));
            // accessMap.put("NCBS", Arrays.asList("NCBS", "EMS"));
            accessMap.put("EMS", Arrays.asList("EMS", "NCBS"));
            accessMap.put("CSA", Arrays.asList("CSA", "CUSTODY"));
            accessMap.put("CUSTODY", Arrays.asList("CSA", "CUSTODY"));

            List<String> allowed = accessMap.getOrDefault(userChannel, Arrays.asList(userChannel));

            // ke 404 jika channel tidak sesuai
            if (!allowed.contains(dataChannel) && userChannel != null && !userChannel.isEmpty()) {
...
//            System.out.println("Rekening:" + rekening);
        ...
        if ("103".equalsIgnoreCase(typeMT) || "110".equalsIgnoreCase(typeMT) || "111".equalsIgnoreCase(typeMT) || "191".equalsIgnoreCase(typeMT) || "192".equalsIgnoreCase(typeMT) || 
                "202".equalsIgnoreCase(typeMT) || "202COV".equalsIgnoreCase(typeMT) || "210".equalsIgnoreCase(typeMT) || 
                "543".equalsIgnoreCase(typeMT) || 
                "700".equalsIgnoreCase(typeMT) || "701".equalsIgnoreCase(typeMT) || "707".equalsIgnoreCase(typeMT) || "708".equalsIgnoreCase(typeMT) || "710".equalsIgnoreCase(typeMT) || "711".equalsIgnoreCase(typeMT) || "720".equalsIgnoreCase(typeMT) || "730".equalsIgnoreCase(typeMT) || "734".equalsIgnoreCase(typeMT) || "740".equalsIgnoreCase(typeMT) || "742".equalsIgnoreCase(typeMT) || "747".equalsIgnoreCase(typeMT) || "754".equalsIgnoreCase(typeMT) || "756".equalsIgnoreCase(typeMT) || "759".equalsIgnoreCase(typeMT) || "760".equalsIgnoreCase(typeMT) || "761".equalsIgnoreCase(typeMT) || "767".equalsIgnoreCase(typeMT) ||
                "940".equalsIgnoreCase(typeMT) || "950".equalsIgnoreCase(typeMT)
                ) {
            try {
...
//            System.out.println("receiverBank : "+receiverBank);
        ...
        if (headerById.getNetworktype().contains("MT")) {
            if (headerById.getMessageType().contains("103") || headerById.getMessageType().contains("110") || headerById.getMessageType().contains("111") || headerById.getMessageType().contains("191") || headerById.getMessageType().contains("192") || headerById.getMessageType().contains("199") || 
                    headerById.getMessageType().contains("200") || headerById.getMessageType().contains("202") || headerById.getMessageType().contains("210") || headerById.getMessageType().contains("299") ||
                    headerById.getMessageType().contains("543") ||
                    headerById.getMessageType().contains("700") || headerById.getMessageType().contains("701") || headerById.getMessageType().contains("707") || headerById.getMessageType().contains("708") || headerById.getMessageType().contains("710") || headerById.getMessageType().contains("711") || headerById.getMessageType().contains("720") || headerById.getMessageType().contains("730") || headerById.getMessageType().contains("734") || headerById.getMessageType().contains("740") || headerById.getMessageType().contains("742") || headerById.getMessageType().contains("747") || headerById.getMessageType().contains("754") || headerById.getMessageType().contains("756") || headerById.getMessageType().contains("759") || headerById.getMessageType().contains("760") || headerById.getMessageType().contains("761") || headerById.getMessageType().contains("767") ||
                    headerById.getMessageType().contains("940") || headerById.getMessageType().contains("950")
                    ) {
