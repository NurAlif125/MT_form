 ...
 * @author AplDev2
 */
public class SCPrintNota extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        File reportFile = new File(getServletConfig().getServletContext().getRealPath("/WEB-INF/reports/reportMTNote.jasper"));
        byte[] bytes = null;
        try {
            headers = bBHeaders.printMTNota(request.getParameter("id"));
