...
//    private Date tanggal_date;
    ...
    // 20250806
    private String tag11sNumber;
    private String tag11sDate;
    private String tag11sSessionNumber;
    // 20250807
    private String tag71B;
    ...
    public String getTag11sNumber() {
        return tag11sNumber;
    }

    public void setTag11sNumber(String tag11sNumber) {
        this.tag11sNumber = tag11sNumber;
    }

    public String getTag11sDate() {
        return tag11sDate;
    }

    public void setTag11sDate(String tag11sDate) {
        this.tag11sDate = tag11sDate;
    }

    public String getTag11sSessionNumber() {
        return tag11sSessionNumber;
    }

    public void setTag11sSessionNumber(String tag11sSessionNumber) {
        this.tag11sSessionNumber = tag11sSessionNumber;
    }
    
    public String getTag71B() {
        return tag71B;
    }

    public void setTag71B(String tag71B) {
        this.tag71B = tag71B;
    }
