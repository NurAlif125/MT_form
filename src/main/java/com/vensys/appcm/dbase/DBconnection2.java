...
public class DBconnection2 {
    ...
    public DBconnection2() {
        try {
            ...
            loggerContext.setConfigLocation(getClass().getResource("/log4j2.properties").toURI());
...
//                    System.out.println("Secret berhasil dimuat (panjang): " + secretKey);
                ...
                try {
                    USER = enc.decryptTD(prop.getProperty("user2"), secretKey);
                    PASS = enc.decryptTD(prop.getProperty("password2"), secretKey);
                } catch (Exception ex) {
