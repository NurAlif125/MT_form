...
public class DBUserData {
    ...
    public DataUser getUserDataById(String str) throws SQLException {
        ...
        String sql = "SELECT user_id,name,password,status_new,user_mt_routing,description,role,idrulepass,wrongpass,enable,group_limit,channel,user_bic FROM users WHERE user_id=?";
