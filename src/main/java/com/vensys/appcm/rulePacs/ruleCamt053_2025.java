    ...
    public void runRules(String logicalTerminal, String receiverAddress) {
        ...
        if (grpHdr != null) {
            ...
            if (orgnlBizQry != null) {
                ...
                if ("".equalsIgnoreCase(orgnlBizQryMsgId)) {
            ...
            if (addtlInf != null) {
                if (!"/EODY/".equalsIgnoreCase(addtlInf) || !"/EOWK/".equalsIgnoreCase(addtlInf) || !"/EOMH/".equalsIgnoreCase(addtlInf) || !"/EOYR/".equalsIgnoreCase(addtlInf)) {
                    ...
                    if (bal != null) {
                        for (int i = 0; i < bal.size(); i++) {
                            ...
                            if (tp != null) {
                                ...
                                if (subTp != null) {
                                    String cd = subTp.getCd();
                                    if (count == 2 && "INTM".equalsIgnoreCase(cd)) {
