...
<div id="isi">
    <c:forEach var="item" items="${role}">
        <c:if test="${item == 'MT:196'}">
            <div id="judul">MT 196 Answers</div>
            <form id="form1" name="form1" method="post" action="ServletControllerDataTransaksiOutgoing">
                <input name="messageType" id="messageType" type="hidden" value="196" />
                    ...
                    <div class="tabcontents">
                        ...
                        <div id="view2" class="tabcontent">
                            ...
                            <div class="form-row"><span class="label_body">MF76</span><span class="label">*Answers</span>
                                <textarea name="_012_mf76_answers" id="_012_mf76_answers" ><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_012_mf76_answers'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                            </div>
                            <hr/>
