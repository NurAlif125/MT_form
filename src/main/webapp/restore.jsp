...
<div id="isi">
    <c:forEach var="item" items="${role}">
        <c:if test="${item == 'MENU:HOUSEKEEPING'}">
            <div id="judul">Transaction Restore</div>
            <div id="tabs-1">
                <form id="form1" name="form1" method="post" action="SCRestore">
            ...
            <div id="content">
                ...
                <table id="example" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                    <c:forEach items="${restore}" var="item">
                        <tr>
                            <td><%=rowNum++%></td>
                            <c:choose>
