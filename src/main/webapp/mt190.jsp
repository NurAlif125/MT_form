...
<div id="isi">
    <c:forEach var="item" items="${role}">
        <c:if test="${item == 'MT:190'}">
            <div id="judul">MT 190 Advice of Charges, Interest and Other Adjustments</div>
            <form id="form1" name="form1" method="post" action="ServletControllerDataTransaksiOutgoing">
                <input name="messageType" id="messageType" type="hidden" value="190" />
