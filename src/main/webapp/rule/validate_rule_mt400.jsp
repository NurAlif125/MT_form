    ...
    $(document).ready(function() {
        $("#form1").validate({
            rules: {
                ...
                _036_mf32k_daysmonth: "required",
                _037_mf32k_numberofdaysmonth: "required",
                _038_mf32k_code: "required",

                //mf33A
                type_mf33a_a_proceeds_remitted: "required",
                _041_mf33a_a_date: "required",
                _042_mf33a_a_currency: "required",
                _043_mf33a_a_amount: "required",
            ...
            messages: {
                ...
                _020_mf21_related_reference: {required: "mf21 related references harus diisi..!!"},
                
                type_mf32_amount_collected: {required: "type mf32 amount collected harus diisi..!!"},
                ...
                _036_mf32k_daysmonth: {required: "_036_mf32k_daysmonth harus diisi..!!"},
                _037_mf32k_numberofdaysmonth: {required: " _037_mf32k_numberofdaysmonth harus diisi..!!"},
                _038_mf32k_code: {required: " _038_mf32k_code harus diisi..!!"},
                type_mf33a_a_proceeds_remitted: {required: " _038_mf32k_code harus diisi..!!"},
                _041_mf33a_a_date: {required: " _041_mf33a_a_date harus diisi..!!"},
                _042_mf33a_a_currency: {required: " _042_mf33a_a_currency harus diisi..!!"},
                _043_mf33a_a_amount:{required: " _043_mf33a_a_amount harus diisi..!!"},
//                
            },
...
<script language="javascript">
    $(document).ready(function() {
        ...
        //mf32 a b k
         if ($("#_031_mf32a_date").val() != "" || $("#_032_mf32a_currency").val() != "" || $("#_033_mf32a_amount").val() != "") {
            ...
            $("#_039_mf32k_currency").attr("disabled", true);
            $("#_040_mf32k_amount").attr("disabled", true);
        } else if ($("#_036_mf32k_daysmonth").val() != "" || $("#_037_mf32k_numberofdaysmonth").val() != "" || $("#_038_mf32k_code").val() != "" || $("#_039_mf32k_currency").val() != "" || $("#_040_mf32k_amount").val() != "") {
        ...
        //mf33A//
        if ($("#_041_mf33a_a_date").val() != "" || $("#_042_mf33a_a_currency").val() != "" || $("#_043_mf33a_a_amount").val() != ""){
  ...
  if ($("#_051_of52a_party_identifier").val() != "" || $("#_052_of52a_identifier_code").val() != ""){
            ...
            $("#_053_of52d_party_identifier").attr("disabled", true);
            $("#_054_of52d_name_address").attr("disabled", true);
        } else if ($("#_053_of52d_party_identifier").val() != "" || $("#_054_of52d_name_address").val() != ""){
        ...
        //of53_a_b_d
        if ($("#_061_of53a_party_identifier").val() != "" || $("#_062_of53a_Identifier_code").val() != ""){
            ...
            $("#_065_of53d_party_identifier").attr("disabled", true);
            $("#_066_of53d_name_address").attr("disabled", true);
        } else if ($("#_063_of53b_party_identifier").val() != "" || $("#_064_of53b_location").val() != ""){
            ...
            $("#_065_of53d_party_identifier").attr("disabled", true);
            $("#_066_of53d_name_address").attr("disabled", true);
        } else if ($("#_065_of53d_party_identifier").val() != "" || $("#_066_of53d_name_address").val() != ""){
         ...
         if ($("#_071_of54a_party_identifier").val() != "" || $("#_072_of54a_Identifier_code").val() != ""){
            ...
            $("#_075_of54d_party_identifier").attr("disabled", true);
            $("#_076_of54d_name_address").attr("disabled", true);
        } else if ($("#_073_of54b_party_identifier").val() != "" || $("#_074_of54b_location").val() != ""){
            ...
            $("#_075_of54d_party_identifier").attr("disabled", true);
            $("#_076_of54d_name_address").attr("disabled", true);
        } else if ($("#_075_of54d_party_identifier").val() != "" || $("#_076_of54d_name_address").val() != ""){
        ...
        if ($("#_081_of57a_party_identifier").val() != "" || $("#_082_of57a_identifier_code").val() != ""){
            ...
            $("#_083_of57d_party_identifier").attr("disabled", true);
            $("#_084_of57d_name_address").attr("disabled", true);
        } else if ($("#_083_of57d_party_identifier").val() != "" || $("#_084_of57d_name_address").val() != ""){
        ...
        //of58//
         if ($("#_091_of58a_party_identifier").val() != "" || $("#_092_of58a_Identifier_code").val() != ""){
        ...
        } else if ($("#_093_of58b_party_identifier").val() != "" || $("#_094_of58b_location").val() != ""){
