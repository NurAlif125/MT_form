    ...
    $(document).ready(function () {
        $("#form1").validate({
            rules: {
                ...
                //mf20
                _020_mf20_Transferring_Banks_Reference: "required",
            ...
            messages: {
                ...
                _010_mf27_Sequence_of_Total: {required: "mf27 Number harus diisi..!!"},
                _020_mf20_Transferring_Banks_Reference: {required: "mf27 Total harus diisi..!!"},
