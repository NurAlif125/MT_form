<%-- 
    ...
    Created on : Aug 23, 2019, 11:31:41 AM
    Author     : AplDev2
--%>
...
//                
            ...
            messages:{
                ...
                _045_mf22c_common_reference: {required: "mf22c_common_reference harus diisi..!!"},
                type_mf82_: {required: "type_mf82_ harus diisi..!!"},
                _072_mf82a_identifier_code: {required: "mf82a_identifier_code harus diisi..!!"},
                _075_mf82d_name_address: {required: "mf82d_name_address harus diisi..!!"},
                _076_mf82j_party_identification: {required: "mf82j_party_identification harus diisi..!!"},
                _082_mf87a_identifier_code: {required: "mf87a_identifier_code harus diisi..!!"},
                _085_mf87d_name_address: {required: "mf87d_name_address harus diisi..!!"},
                _086_mf87j_party_identification: {required: "mf87j_party_identification harus diisi..!!"},
                _092_of83a_identifier_code: {required: "of83a_identifier_code harus diisi..!!"},
                _095_of83d_name_address: {required: "of83d_name_address harus diisi..!!"},
                _096_of83j_party_identification: {required: "of83j_party_identification harus diisi..!!"},
                _120_mf30t_trade_date: {required: "mf30t_trade_date harus diisi..!!"},
                _130_mf30v_value_date: {required: "mf30v_value_date harus diisi..!!"},
                _140_mf36_exchange_rate: {required: "mf36_exchange_rate harus diisi..!!"},
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //check_of17i
        $("#check_of17i").hide();
        $("#_065_of17i_payment_versus_payment_settlement_indicator").attr("disabled", true);
        $("#payment_versus_payment_settlement_indicator_checkbox").click(function () {
            if ($("#payment_versus_payment_settlement_indicator_checkbox").is(":checked")) {
                $("#check_of17i").show();
                $("#_065_of17i_payment_versus_payment_settlement_indicator").attr("disabled", false);
            } else {
                $("#check_of17i").hide();
                $("#_065_of17i_payment_versus_payment_settlement_indicator").attr("disabled", true);
            }
...
<script language="javascript">
    $(document).ready(function () {
        //mf82_a_d_j
        if ($("#_071_mf82a_party_identifier").val() != "" || $("#_072_mf82a_identifier_code").val() != "") {
            ...
            $("#_075_mf82d_name_address").attr("disabled", true);
            $("#_076_mf82j_party_identification").attr("disabled", true);
        } else if ($("#_074_mf82d_party_identifier").val() != "" || $("#_075_mf82d_name_address").val() != "") {
        ...
        //end of the line
        //mf87_a_d_j
        if ($("#_081_mf87a_party_identifier").val() != "" || $("#_082_mf87a_identifier_code").val() != "") {
            ...
            $("#_085_mf87d_name_address").attr("disabled", true);
            $("#_086_mf87j_party_identification").attr("disabled", true);
        } else if ($("#_084_mf87d_party_identifier").val() != "" || $("#_085_mf87d_name_address").val() != "") {
        ...
        //end of the line
        //of83_a_d_j
        if ($("#_091_of83a_party_identifier").val() != "" || $("#_092_of83a_identifier_code").val() != "") {
            ...
            $("#_095_of83d_name_address").attr("disabled", true);
            $("#_096_of83j_party_identification").attr("disabled", true);
        } else if ($("#_094_of83d_party_identifier").val() != "" || $("#_095_of83d_name_address").val() != "") {
        ...
        //end of the line
        //of77h
        if ($("#_097_of77h_type_of_agreement").val() != "" || $("#value_date_7").val() != "" || $("#_099_of77h_version").val() != "") {
        ...
        //end of the line
        //of53_a_d_j
        if ($("#_171_of53a_party_identifier").val() != "" || $("#_172_of53a_identifier_code").val() != "") {
            ...
            $("#_175_of53d_name_address").attr("disabled", true);
            $("#_176_of53j_party_identification").attr("disabled", true);
        } else if ($("#_174_of53d_party_identifier").val() != "" || $("#_175_of53d_name_address").val() != "") {
        ...
        if ($("#_181_of56a_party_identifier").val() != "" || $("#_182_of56a_identifier_code").val() != "") {
            ...
            $("#_185_of56d_name_address").attr("disabled", true);
            $("#_186_of56j_party_identification").attr("disabled", true);
        } else if ($("#_184_of56d_party_identifier").val() != "" || $("#_185_of56d_name_address").val() != "") {
        ...
        //end of the line
        //mf57_a_d_j
        if ($("#_191_mf57a_party_identifier").val() != "" || $("#_192_mf57a_identifier_code").val() != "") {
            ...
            $("#_195_mf57d_name_address").attr("disabled", true);
            $("#_196_mf57j_party_identification").attr("disabled", true);
        } else if ($("#_194_mf57d_party_identifier").val() != "" || $("#_195_mf57d_name_address").val() != "") {
        ...
        //Mandatory Subsequence B2 Amount Sold
        //of53_a_d_j
        if ($("#_211_of53a_party_identifier").val() != "" || $("#_212_of53a_identifier_code").val() != "") {
            ...
            $("#_215_of53d_name_address").attr("disabled", true);
            $("#_216_of53j_party_identification").attr("disabled", true);
        } else if ($("#_214_of53d_party_identifier").val() != "" || $("#_215_of53d_name_address").val() != "") {
        ...
        //end of the line
        //of56_a_d_j
        if ($("#_221_of56a_party_identifier").val() != "" || $("#_222_of56a_identifier_code").val() != "") {
            ...
            $("#_225_of56d_name_address").attr("disabled", true);
            $("#_226_of56j_party_identification").attr("disabled", true);
        } else if ($("#_224_of56d_party_identifier").val() != "" || $("#_225_of56d_name_address").val() != "") {
        ...
        //end of the line
        //mf57_a_d_j
        if ($("#_231_mf57a_party_identifier").val() != "" || $("#_232_mf57a_identifier_code").val() != "") {
            ...
            $("#_235_mf57d_name_address").attr("disabled", true);
            $("#_236_mf57j_party_identification").attr("disabled", true);
        } else if ($("#_234_mf57d_party_identifier").val() != "" || $("#_235_mf57d_name_address").val() != "") {
        ...
        //end of the line
        //of58
        if ($("#_241_of58a_party_identifier").val() != "" || $("#_242_of58a_identifier_code").val() != "") {
            ...
            $("#_245_of58d_name_address").attr("disabled", true);
            $("#_246_of58j_party_identification").attr("disabled", true);
        } else if ($("#_244_of58d_party_identifier").val() != "" || $("#_245_of58d_name_address").val() != "") {
        ...
        //Optional Sequence C Optional General Information
        //of84_a_b_d_j
        if ($("#_271_of84a_party_identifier").val() != "" || $("#_272_of84a_identifier_code").val() != "") {
            ...
            $("#_277_of84d_name_and_address").attr("disabled", true);
            $("#_278_of84j_party_identification").attr("disabled", true);
        } else if ($("#_274_of84b_party_identifier").val() != "" || $("#_275_of84b_location").val() != "") {
            ...
            $("#_277_of84d_name_and_address").attr("disabled", true);
            $("#_278_of84j_party_identification").attr("disabled", true);
        } else if ($("#_276_of84d_party_identifier").val() != "" || $("#_277_of84d_name_and_address").val() != "") {
        ...
        //end of the line
        //of85_a_b_d_j
        if ($("#_281_of85a_party_identifier").val() != "" || $("#_282_of85a_identifier_code").val() != "") {
            ...
            $("#_287_of85d_name_and_address").attr("disabled", true);
            $("#_288_of85j_party_identification").attr("disabled", true);
        } else if ($("#_284_of85b_party_identifier").val() != "" || $("#_285_of85b_location").val() != "") {
            ...
            $("#_287_of85d_name_and_address").attr("disabled", true);
            $("#_288_of85j_party_identification").attr("disabled", true);
        } else if ($("#_286_of85d_party_identifier").val() != "" || $("#_287_of85d_name_and_address").val() != "") {
        ...
        //end of the line
        //of88_a_d_j
        if ($("#_291_of88a_party_identifier").val() != "" || $("#_292_of88a_identifier_code").val() != "") {
            ...
            $("#_295_of88d_name_and_address").attr("disabled", true);
            $("#_296_of88j_party_identification").attr("disabled", true);
        } else if ($("#_294_of88d_party_identifier").val() != "" || $("#_295_of88d_name_and_address").val() != "") {
        ...
        //end of the line
        //of24d
        if ($("#_260_of24d_dealing_method").val() != "" || $("#_261_of24d_additional_information").val() != "") {
        ...
        //end of the line
        //of71f
        if ($("#_300_of71f_currency").val() != "" || $("#_301_of71f_amount").val() != "") {
        ...
        //end of the line
        //of72
        if ($("#_330_of72_code").val() != "" || $("#_331_of72_narrative").val() != "") {
        ...
        //Optional Sequence D Split Settlement Details
        //of53_a_d_j
        if ($("#_371_of53a_party_identifier").val() != "" || $("#_372_of53a_identifier_code").val() != "") {
            ...
            $("#_375_of53d_name_address").attr("disabled", true);
            $("#_376_of53j_party_identification").attr("disabled", true);
        } else if ($("#_374_of53d_party_identifier").val() != "" || $("#_375_of53d_name_address").val() != "") {
        ...
        //end of the line
        //of56_a_d_j
        if ($("#_381_of56a_party_identifier").val() != "" || $("#_382_of56a_identifier_code").val() != "") {
            ...
            $("#_385_of56d_name_address").attr("disabled", true);
            $("#_386_of56j_party_identification").attr("disabled", true);
        } else if ($("#_384_of56d_party_identifier").val() != "" || $("#_385_of56d_name_address").val() != "") {
        ...
        //end of the line
        //mf57_a_d_j
        if ($("#_391_mf57a_party_identifier").val() != "" || $("#_392_mf57a_identifier_code").val() != "") {
            ...
            $("#_395_mf57d_name_address").attr("disabled", true);
            $("#_396_mf57j_party_identification").attr("disabled", true);
        } else if ($("#_394_mf57d_party_identifier").val() != "" || $("#_395_mf57d_name_address").val() != "") {
        ...
        //end of the line
        //of58_a_d_j
        if ($("#_401_of58a_party_identifier").val() != "" || $("#_402_of58a_identifier_code").val() != "") {
            ...
            $("#_405_of58d_name_address").attr("disabled", true);
            $("#_406_of58j_party_identification").attr("disabled", true);
        } else if ($("#_404_of58d_party_identifier").val() != "" || $("#_405_of58d_name_address").val() != "") {
        ...
        //end of the line
        //Seq C checkbox
        if ($("#_260_of24d_dealing_method").val() != "" || $("#_330_of72_code").val() != "" || $("#_272_of84a_identifier_code").val() != "" || $("#_277_of84d_name_and_address").val() != "" || $("#_278_of84j_party_identification").val() != "" || $("#_282_of85a_identifier_code").val() != "" || $("#_287_of85d_name_and_address").val() != "" || $("#_288_of85j_party_identification").val() != "" || $("#_292_of88a_identifier_code").val() != "" || $("#_295_of88d_name_and_address").val() != "" || $("#_296_of88j_party_identification").val() != ""){
...
//        }
        ...
        //end of the line
        //check_of17i
        if ($("#_065_of17i_payment_versus_payment_settlement_indicator").val() != "") {
            $("#payment_versus_payment_settlement_indicator_checkbox").attr("checked", true);
            $("#check_of17i").show();
            $("#_065_of17i_payment_versus_payment_settlement_indicator").attr("disabled", false);
        } else {
            $("#check_of17i").hide();
