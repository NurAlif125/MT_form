<%--
    Document   : validate_rule_mt769
    Created on : Feb 27, 2024, 10:14:20 AM
    Author     : LENOVO
--%>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#div_of57b_").hide();
        $("#div_of57d_").hide();
        $("#_031_of57a_party_identifier").attr("disabled", true);
        $("#_032_of57a_identifier_code").attr("disabled", true);
        $("#_100_of57b_party_identifier").attr("disabled", true);
        $("#_101_of57b_location").attr("disabled", true);
        $("#_102_of57d_party_identifier").attr("disabled", true);
        $("#_103_of57d_name_and_address").attr("disabled", true);
        $("#type_of57_").change(function() {
            if ( $("#type_of57_").val() == "a"){
                $("#div_of57a_").show();
                $("#div_of57b_").hide();
                $("#div_of57d_").hide();
                $("#_031_of57a_party_identifier").attr("disabled", false);
                $("#_032_of57a_identifier_code").attr("disabled", false);
                $("#_100_of57b_party_identifier").attr("disabled", true);
                $("#_101_of57b_location").attr("disabled", true);
                $("#_102_of57d_party_identifier").attr("disabled", true);
                $("#_103_of57d_name_and_address").attr("disabled", true);
                ...
                $("#_031_of57a_party_identifier").attr("disabled", true);
                $("#_032_of57a_identifier_code").attr("disabled", true);
                $("#_100_of57b_party_identifier").attr("disabled", false);
                $("#_101_of57b_location").attr("disabled", false);
                $("#_102_of57d_party_identifier").attr("disabled", true);
                $("#_103_of57d_name_and_address").attr("disabled", true);
                ...
                $("#_100_of57b_party_identifier").attr("disabled", true);
                $("#_101_of57b_location").attr("disabled", true);
                $("#_102_of57d_party_identifier").attr("disabled", false);
                $("#_103_of57d_name_and_address").attr("disabled", false);
            } else{
                $("#div_of57a_").hide();
                $("#div_of57b_").hide();
                $("#div_of57d_").hide();
...
<script language="javascript">
    $(document).ready(function() {
        ...
        //OF57_a_b_d
        if ($("#_031_of57a_party_identifier").val() != "" || $("#_032_of57a_identifier_code").val() != ""){
            ...
            $("#_102_of57d_party_identifier").attr("disabled", true);
            $("#_103_of57d_name_and_address").attr("disabled", true);
        } else if ($("#_100_of57b_party_identifier").val() != "" || $("#_101_of57b_location").val() != ""){
            ...
            $("#_102_of57d_party_identifier").attr("disabled", true);
            $("#_103_of57d_name_and_address").attr("disabled", true);
        } else if ($("#_102_of57d_party_identifier").val() != "" || $("#_103_of57d_name_and_address").val() != ""){
