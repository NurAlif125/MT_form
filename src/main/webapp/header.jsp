...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <ul id="nav" class="dropdown dropdown-horizontal">
        ...
        <c:forEach var="item" items="${role}">
            <c:if test="${(item == 'MENU:ADMINISTRATOR')}">
                    ...
                    <ul>
                        ...
                        <c:forEach var="item" items="${role}">
                            <c:if test="${item == 'TIERING_LIMIT:LIST'}">
                                <li><a onclick="userTrackMenuClick('Tiering Limit')" href="VDataTieringLimit.jsp">Limit Approval</a></li>
                            </c:if>
                        </c:forEach>
                        <c:forEach var="item" items="${role}">
                            <c:if test="${item == 'ROLE:EXCDUPL'}">
                                <li><a onclick="userTrackMenuClick('Exclude Duplicate')" href="SCExcluteDuplicate">Exclude Duplicate</a></li>
                            </c:if>
                        </c:forEach>
                    </ul>
                </li>
        ...
        <c:forEach var="item" items="${role}">
            <c:if test="${(item == 'FLOW:CREATE')}">
                <li><span class="dir">Create Message</span>
                    <ul>
                    <c:forEach var="item" items="${role}">
                        <c:if test="${(item == 'MENU:MT')}">
                        <li><span class="dir">MT</span>
                            <ul>
                            <c:forEach var="item" items="${role}">
                                <c:if test="${(item == 'MSG:CAT1')}">
                                    ...
                                    <ul>
                                        <c:forEach var="item" items="${role}">
                                            <c:if test="${item == 'MT:700'}">
                                                <li><a onclick="userTrackMenuClick('700 - Issue of a Documentary Credit')" href="mt700.jsp?create=true">700 - Issue of a Documentary Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:701'}">
                                                <li><a onclick="userTrackMenuClick('701 - Issue of a Documentary Credit (Continuation)')" href="mt701.jsp?create=true">701 - Issue of a Documentary Credit (Continuation)</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:707'}">
                                                <li><a onclick="userTrackMenuClick('707 - Amendment to a Documentary Credit')" href="mt707.jsp?create=true">707 - Amendment to a Documentary Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:708'}">
                                                <li><a onclick="userTrackMenuClick('708 - Amendment to a Documentary Credit (Continuation)')" href="mt708.jsp?create=true">708 - Amendment to a Documentary Credit (Continuation)</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:710'}">
                                                <li><a onclick="userTrackMenuClick('710 - Advice of Third Bank\'s or a Non-Bank\'s Documentary Credit')" href="mt710.jsp?create=true">710 - Advice of Third Bank's or a Non-Bank's Documentary Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:711'}">
                                                <li><a onclick="userTrackMenuClick('711 - Advice of Third Bank\'s or a Non-Bank\'s Documentary Credit (Continuation)')" href="mt711.jsp?create=true">711 - Advice of Third Bank's or a Non-Bank's Documentary Credit (Continuation)</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:720'}">
                                                <li><a onclick="userTrackMenuClick('720 - Transfer of a Documentary Credit')" href="mt720.jsp?create=true">720 - Transfer of a Documentary Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:730'}">
                                                <li><a onclick="userTrackMenuClick('730 - Acknowledgement')" href="mt730.jsp?create=true">730 - Acknowledgement</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:734'}">
                                                <li><a onclick="userTrackMenuClick('734 - Advice of Refusal')" href="mt734.jsp?create=true">734 - Advice of Refusal</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:740'}">
                                                <li><a onclick="userTrackMenuClick('740 - Authorisation to Reimburse')" href="mt740.jsp?create=true">740 - Authorisation to Reimburse</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:742'}">
                                                <li><a onclick="userTrackMenuClick('742 - Reimbursement Claim')" href="mt742.jsp?create=true">742 - Reimbursement Claim</a></li>
                                            </c:if>
                                            ...
                                            <c:if test="${item == 'MT:760'}">
                                                <li><a onclick="userTrackMenuClick('760 - Issue of a Demand Guarantee/Standby Letter of Credit')" href="mt760.jsp?create=true">760 - Issue of a Demand Guarantee/Standby Letter of Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:761'}">
                                                <li><a onclick="userTrackMenuClick('761 - Issue of a Demand Guarantee/Standby Letter of Credit')" href="mt761.jsp?create=true">761 - Issue of a Demand Guarantee/Standby Letter of Credit</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:767'}">
                                                <li><a onclick="userTrackMenuClick('767 - Amendment to a Demand Guarantee/Standby Letter of Credit')" href="mt767.jsp?create=true">767 - Amendment to a Demand Guarantee/Standby Letter of Credit</a></li>
                                            </c:if>
                                        </c:forEach>
                                    </ul>
                                </li>
                                    ...
                                    <ul>
                                        <c:forEach var="item" items="${role}">
                                            <c:if test="${item == 'MT:940'}">
                                                <li><a onclick="userTrackMenuClick('940 - Customer Statement Message')" href="mt940.jsp?create=true">940 - Customer Statement Message</a></li>
                                            </c:if>
                                            <c:if test="${item == 'MT:950'}">
                                                <li><a onclick="userTrackMenuClick('950 - Statement Message')" href="mt950.jsp?create=true">950 - Statement Message</a></li>
                                            </c:if>
                                        </c:forEach>
                                    </ul>
                                </li>
                ...
                <c:forEach var="item" items="${role}">
                    <c:if test="${(item == 'MENU:MX')}">
                        <li><span class="dir">MX</span>
                            <ul>
                            <c:forEach var="item" items="${role}">
                            <c:if test="${(item == 'MENU:PACS')}">
...
<!--                                <li><span class="dir">Cash Management</span>
                                    <ul>
                                        <c:forEach var="item" items="${role}">
                                            <c:if test="${item == 'MX:camt05300108'}">
                                                ...
                                                <c:if test="${item == 'MX:camt11000101'}">
                                                <li><a onclick="userTrackMenuClick('CAMT.110.001.01 - Investigation Request V01')" href="main_camt110.jsp?create=true">CAMT.110.001.01 - Investigation Request V01</a></li>
                                                </c:if>
                                                <c:if test="${item == 'MX:camt11100101'}">
                                                <li><a onclick="userTrackMenuClick('CAMT.111.001.01 - Investigation Response V01')" href="main_camt111.jsp?create=true">CAMT.111.001.01 - Investigation Response V01</a></li>
                                                </c:if>
                                            </c:forEach>
                                    </ul>
                                </li>
        ...
        <c:forEach var="item" items="${role}">
                                    ...
                                    <ul>
                                        <c:forEach var="iteminc" items="${role}">
                                            ...
                                            <c:forEach var="iteminc" items="${role}">
                                                ...
                                                <li><a onclick="userTrackMenuClick('Incoming Resend to AML')" href="controllerHeaders?io_type=O&flag=AML-FAILED&menu=28">Incoming Resend to AML</a></li>
                                                </c:if>
            ...
            <c:if test="${item == 'MENU:WORKFLOW-LOGS'}">
    ...
    <body style="clear: both;">
        ...
        <c:choose>
            ...
            <c:when test="${empty sessionScope.user_id}">
                ...
                <%
                    session.invalidate(); // hapus session expired
                %>
            </c:when>
        </c:choose>
