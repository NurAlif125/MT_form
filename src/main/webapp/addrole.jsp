            ...
            <form id="form1" name="form1" method="post" action="SCDataRole">
                ...
                <div id="tabs-1" class="formBody">
                    ...
                    <div class="form-row"><span class="labelL">Flow</span>
                        ...
                        <label>Reject AML Confirmation <input type="checkbox" name="role_detail" id="role_detail" value="FLOW:AML-TERMINATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:AML-TERMINATE'}"> checked="true" </c:if></c:forEach> /></label>
                    ...
                    <div class="form-row"><span class="labelL">&nbsp;</span>  
                        ...
                        <label>Incoming Reject AML Confirmation <input type="checkbox" name="role_detail" id="role_detail" value="FLOW:AML-TERMINATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:AML-TERMINATE'}"> checked="true" </c:if> </c:forEach> /></label>
                    </div>
                    <div class="form-row"><span class="labelL">&nbsp;</span>
