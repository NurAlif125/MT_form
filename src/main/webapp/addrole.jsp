            ...
            <form id="form1" name="form1" method="post" action="SCDataRole">
                ...
                <div id="tabs-1" class="formBody">
                    ...
                    <div class="form-row">
                        ...
                        <label>Incoming Maker<input type="checkbox" name="role_detail" id="role_detail" value="FLOW:INCM" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:INCM'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Incoming Sender<input type="checkbox" name="role_detail" id="role_detail" value="FLOW:INCS" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:INCS'}"> checked="true" </c:if></c:forEach> /></label>
                        ...
                        <div class="form-row"><span class="labelL">&nbsp;</span>
                            <label>RESEND ACK <input type="checkbox" name="role_detail" id="role_detail" value="FLOW:RACK" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:RACK'}"> checked="true" </c:if></c:forEach> /></label>
                            <label>RESEND INC-OK <input type="checkbox" name="role_detail" id="role_detail" value="FLOW:INC-ROK" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:INC-ROK'}"> checked="true" </c:if></c:forEach> /></label>
                            <label>DELETE JOURNAL HISTORY <input type="checkbox" name="role_detail" id="role_detail" value="FLOW:DELHIS" <c:forEach var="item" items="${list}"><c:if test="${item == 'FLOW:DELHIS'}"> checked="true" </c:if></c:forEach> /></label>--%>
                    </div> 
                    <div class="form-row"><span class="labelL">Menu</span>
                        ...
                        <%--<label>UPLOAD <input type="checkbox" name="role_detail" id="role_detail" value="MENU:UPLOAD" <c:forEach var="item" items="${list}"><c:if test="${item == 'MENU:UPLOAD'}"> checked="true" </c:if></c:forEach> /></label>--%>
                    ...
                    <%--                    <div class="form-row">
                                            <span class="labelL"> Daily Transactions</span>
                                            <label>List<input type="checkbox" name="role_detail" id="role_detail" value="DT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'DT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                        </div>
                                        <div class="form-row">
                                            <span class="labelL"> Yearly Transactions</span>
                                            <label>List<input type="checkbox" name="role_detail" id="role_detail" value="YT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'YT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                        </div>--%>
                    <div class="form-row">
                        <span class="labelL">STP LIMIT</span>
                        <label>List <input type="checkbox" name="role_detail" id="role_detail" value="STP_LIMIT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'STP_LIMIT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="STP_LIMIT:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'STP_LIMIT:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="STP_LIMIT:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'STP_LIMIT:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="STP_LIMIT:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'STP_LIMIT:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div>
                            <div class="form-row">
                        ...
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="MT_QUEUE:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'MT_QUEUE:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            ...
                            <div class="form-row"><span class="labelL">Cut Off Time</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="COT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'COT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="COT:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'COT:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        ...
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="MEMBER_CODE:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'MEMBER_CODE:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            ...
                            <!--20230502-->
                            <!-- <div class="form-row">
                                <span class="labelL">SWIFT GO BIC</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="BIC_GO:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'BIC_GO:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="BIC_GO:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'BIC_GO:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>View <input type="checkbox" name="role_detail" id="role_detail" value="BIC_GO:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'BIC_GO:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="BIC_GO:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'BIC_GO:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Upload<input type="checkbox" name="role_detail" id="role_detail" value="BIC_GO:UPLOAD" <c:forEach var="item" items="${list}"><c:if test="${item == 'BIC_GO:UPLOAD'}"> checked="true" </c:if></c:forEach> /></label>
                            </div> -->
                            <!--20230504-->
                            <!-- <div class="form-row">
                                <span class="labelL">SWIFT GO LIMIT</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="S_LIMIT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'S_LIMIT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="S_LIMIT:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'S_LIMIT:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>View <input type="checkbox" name="role_detail" id="role_detail" value="S_LIMIT:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'S_LIMIT:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="S_LIMIT:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'S_LIMIT:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div> -->
                            <div class="form-row">
                                <span class="labelL">Counter Rate</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="CTR:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTR:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="CTR:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTR:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="CTR:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTR:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="CTR:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTR:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Upload <input type="checkbox" name="role_detail" id="role_detail" value="CTR:UPLOAD" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTR:UPLOAD'}"> checked="true" </c:if></c:forEach> /></label>
                            </div>
                            <!--20230822-->

                            <div class="form-row">
                                <span class="labelL">Charges</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="CRG:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'CRG:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="CRG:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'CRG:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="CRG:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'CRG:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="CRG:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'CRG:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div>
                            <!-- </div><div class="form-row">
                                <span class="labelL">Account Penagihan</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="ACCP:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCP:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="ACCP:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCP:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>View <input type="checkbox" name="role_detail" id="role_detail" value="ACCP:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCP:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="ACCP:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCP:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div> -->
                            <div class="form-row">
                                <span class="labelL">Nostro</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="NOSTRO:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'NOSTRO:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="NOSTRO:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'NOSTRO:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="NOSTRO:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'NOSTRO:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="NOSTRO:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'NOSTRO:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div>
                            <!-- <div class="form-row">
                                <span class="labelL">Vostro</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="VOSTRO:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'VOSTRO:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="VOSTRO:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'VOSTRO:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>View <input type="checkbox" name="role_detail" id="role_detail" value="VOSTRO:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'VOSTRO:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="VOSTRO:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'VOSTRO:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div> -->
                            <!-- <div class="form-row">
                                <span class="labelL">Fee Remittance</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="FEE_REMIT:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'FEE_REMIT:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="FEE_REMIT:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'FEE_REMIT:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>View <input type="checkbox" name="role_detail" id="role_detail" value="FEE_REMIT:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'FEE_REMIT:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="FEE_REMIT:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'FEE_REMIT:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div> -->
                            <div class="form-row">
                                <span class="labelL">Account Balance</span>
                                <label>List <input type="checkbox" name="role_detail" id="role_detail" value="ACCB:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCB:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="ACCB:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCB:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="ACCB:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCB:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="ACCB:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCB:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            </div>
                    <%--                    <div class="form-row">
                                            <span class="labelL">Verified Account</span>
                                            <label>List <input type="checkbox" name="role_detail" id="role_detail" value="ACCV:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCV:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="ACCV:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCV:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>View <input type="checkbox" name="role_detail" id="role_detail" value="ACCV:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCV:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="ACCV:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'ACCV:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                    </div>--%>
                    <%--                    <div class="form-row">
                                            <span class="labelL">Country Suspect</span>
                                            <label>List <input type="checkbox" name="role_detail" id="role_detail" value="CTY:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTY:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="CTY:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTY:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>View <input type="checkbox" name="role_detail" id="role_detail" value="CTY:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTY:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                                            <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="CTY:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'CTY:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                    </div>--%>
                    <div class="form-row">
                        <%--<label>DELETE <input type="checkbox" name="role_detail" id="role_detail" value="MEMBER_CODE:DELETE" <c:forEach var="item" items="${list}"><c:if test="${item == 'MEMBER_CODE:DELETE'}"> checked="true" </c:if></c:forEach> /></label>
                        <span class="labelL">BRANCH CODE</span>
                        <label>List <input type="checkbox" name="role_detail" id="role_detail" value="BRANCH_CODE:LIST" <c:forEach var="item" items="${list}"><c:if test="${item == 'BRANCH_CODE:LIST'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Add <input type="checkbox" name="role_detail" id="role_detail" value="BRANCH_CODE:ADD" <c:forEach var="item" items="${list}"><c:if test="${item == 'BRANCH_CODE:ADD'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>View <input type="checkbox" name="role_detail" id="role_detail" value="BRANCH_CODE:VIEW" <c:forEach var="item" items="${list}"><c:if test="${item == 'BRANCH_CODE:VIEW'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="BRANCH_CODE:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'BRANCH_CODE:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                        <label>DELETE <input type="checkbox" name="role_detail" id="role_detail" value="BRANCH_CODE:DELETE" <c:forEach var="item" items="${list}"><c:if test="${item == 'BRANCH_CODE:DELETE'}"> checked="true" </c:if></c:forEach> /></label>
                        <br/>--%>
                        ...
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="USER:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'USER:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            <%--<label>Reset Password <input type="checkbox" name="role_detail" id="role_detail" value="USER:RESET" <c:forEach var="item" items="${list}"><c:if test="${item == 'USER:RESET'}"> checked="true" </c:if></c:forEach> /></label>
                            <label>DELETE <input type="checkbox" name="role_detail" id="role_detail" value="USER:DELETE" <c:forEach var="item" items="${list}"><c:if test="${item == 'USER:DELETE'}"> checked="true" </c:if></c:forEach> /></label>--%>
                        ...
                        <label>Update <input type="checkbox" name="role_detail" id="role_detail" value="ROLE:UPDATE" <c:forEach var="item" items="${list}"><c:if test="${item == 'ROLE:UPDATE'}"> checked="true" </c:if></c:forEach> /></label>
                            <%--<label>DELETE <input type="checkbox" name="role_detail" id="role_detail" value="ROLE:DELETE" <c:forEach var="item" items="${list}"><c:if test="${item == 'ROLE:DELETE'}"> checked="true" </c:if></c:forEach> /></label>--%>
                    </div>
                    <%--<div class="form-row"><span class="labelL">HOUSEKEEPING</span>
                    <%--<label>LIVE <input type="checkbox" name="role_detail" id="role_detail" value="HOUSEKEEPING:LIVE" <c:forEach var="item" items="${list}"><c:if test="${item == 'HOUSEKEEPING:LIVE'}"> checked="true" </c:if></c:forEach> /></label>
                    <label>ARCHIVING <input type="checkbox" name="role_detail" id="role_detail" value="HOUSEKEEPING:ARCHIVING" <c:forEach var="item" items="${list}"><c:if test="${item == 'HOUSEKEEPING:ARCHIVING'}"> checked="true" </c:if></c:forEach> /></label>--%>
                    <%--<label>BACKUP <input type="checkbox" name="role_detail" id="role_detail" value="HOUSEKEEPING:BACKUP" <c:forEach var="item" items="${list}"><c:if test="${item == 'HOUSEKEEPING:BACKUP'}"> checked="true" </c:if></c:forEach> /></label>
                    <label>RESTORE <input type="checkbox" name="role_detail" id="role_detail" value="HOUSEKEEPING:RESTORE" <c:forEach var="item" items="${list}"><c:if test="${item == 'HOUSEKEEPING:RESTORE'}"> checked="true" </c:if></c:forEach> /></label>
                </div>--%>
                    <div class="form-row"><span class="labelL">Message Category 1</span>
                        ...
                        <!-- <label>202 COV <input type="checkbox" name="role_detail" id="role_detail" value="MT:202COV" <c:forEach var="item" items="${list}"><c:if test="${item == 'MT:202COV'}"> checked="true" </c:if></c:forEach> /></label> -->
