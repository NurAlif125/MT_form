...
<div id="isi">
    <c:forEach var="roleItem" items="${role}">
        <c:if test="${roleItem == 'MEMBER_CODE:ADD'}">
            ...
            <form id="form1" name="form1" method="post" action="SCBIC">
                ...
                <div id="tabs-1" class="formBody">
                    ...
                    <div class="form-row">
                        ...
                        <textarea name="address" id="address" style="text-transform: uppercase"><c:out value="${bicById.address}" /></textarea>
                    </div>
                    <div class="form-row">
                        <span class="labelL2">Note</span>
                        <textarea name="note" id="note"><c:out value="${bicById.note}" /></textarea>
                    </div>
                </div>
