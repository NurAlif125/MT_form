    ...
    <div class="modal-wrapper">
        ...
        <div class="modal-content">
            <table class="modal-table">
                <tr>
                    <th id="th-incoming" colspan="6">INCOMING</th>
                </tr>
                <tr id="tr-header">
                    <td>No</td>
                    <td>Status</td>
                ...
                <tr>
                    ...
                    <td>WAITING-AML &#10141; AML-TERMINATE-IN</td>
                </tr>
                <tr>
                    <td>4</td>
                ...
                <tr>
                    ...
                    <td>AML-FAILED &#10141; INC-AML-FAILED-CNF</td>
                </tr>
                <tr>
                    <td>6</td>
            ...
            <table class="modal-table" >
                <tr>
                    <th id="th-outgoing" colspan="6">OUTGOING</th>
                </tr>
                <tr class="tr-header">
                    <td>No</td>
                    <td>Status</td>
            ...
            <table class="modal-table">
                <tr>
                    <th id="th-flagsementara" colspan="3">FLAG SEMENTARA</th>
                </tr>
                <tr class="tr-header">
                    <td>No</td>
                    <td>Status</td>
...
<script type="text/javascript" src="js/datatables-msg-list.js"></script>
