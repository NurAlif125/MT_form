                    ...
                    <div class="tabcontents">
                        ...
                        <div id="view2" class="tabcontent">
                            ...
                            <div class="form-row"><span class="label_body">MF79</span><span class="label"><a style="color:red;text-decoration:none">*</a>Narrative</span>
                                <textarea cols="50" rows="35" maxlength="1750" wrap="hard" style="resize:none;" name="_012_mf79_Narrative" id="_012_mf79_Narrative" class="mandatory"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_012_mf79_Narrative'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                            </div>
                            <hr/>
                        </div>
