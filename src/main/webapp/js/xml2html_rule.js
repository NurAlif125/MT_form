 ...
 */
        ...
        var getContent = function (node) {
            if (node.getElementsByTagName("input").length != 0) {
                switch (node.getElementsByTagName("input")[0].getAttribute("type").toLowerCase()) {
                    ...
                    case "time":
                    case "datetime-local":
                        console.log(node.getElementsByTagName("input")[0].getAttribute("value"))
        ...
        var ensureMinimum = function () {
            document.querySelectorAll("[data-xsd2html2xml-min], [data-xsd2html2xml-max]").forEach(function (o) {
                ...
                if (o.hasAttribute("data-xsd2html2xml-min")) {
                    ...
                    // APakah mau diremove atau tidak
                    var mustBeRemoved = true

                    // console.log(o.previousElementSibling.previousElementSibling)

                    // ambil anakan
                    var kidNodes = o.previousElementSibling.previousElementSibling.querySelectorAll("input, textarea, select");

                    // for loop anakan
                    kidNodes.forEach(function(data){
                        if (data && data.hasAttribute("data-xsd2html2xml-filled")){
                            // console.log("Ada isi")
                            // console.log(data)
                            mustBeRemoved = false;
                        }
                    ...
                    if (o.getAttribute("data-xsd2html2xml-min") === "0" && mustBeRemoved){

                        

                        // Jika ada nilainya maka remove aja neng
                        // if (mustBeRemoved){
                            // console.log(o.parentElement.children[0].querySelector("legend > button.remove, span > button.remove"))
                            clickRemoveButton(
                        ...
                        if ((o.previousElementSibling.previousElementSibling)){
                            if (o.previousElementSibling.previousElementSibling.querySelector("input, textarea, select") 
                                &&
        ...
        var xmlToHTML = function (root) {
            ...
            if (document.querySelector("meta[name='generator'][content='XSD2HTML2XML v3: https://github.com/MichielCM/xsd2html2xml']").getAttribute("data-xsd2html2xml-source")) {
                ...
                // console.log(xmlDocument.childNodes[0])
        ...
        var convertToLocalDatetime = function (isoString) {
            ...
            // Format the datetime to 'YYYY-MM-DDThh:mm'
            return `${year}-${month}-${day}T${hours}:${minutes}:${seconds}`;
        };
        
        var convertToLocalDate = function (isoString) {
            const date = new Date(isoString);
        ...
        var setValue = function (element, value) {
            ...
            // console.log(element.querySelector("input, textarea, select"))
            // console.log("2. "+element.getAttribute("data-xsd2html2xml-xpath")+" ("+value+") is filled "+
            // element.querySelector("input, textarea, select").getAttribute("data-xsd2html2xml-filled"))
            ...
            if (element.querySelector("input") !== null) {
                ...
                else if (element.querySelector("input").getAttribute("data-xsd2html2xml-primitive") === "datetime"){
//                    console.log(value)
                    element.querySelector("input").setAttribute("value", convertToLocalDatetime(value));
                }
                
                else if (element.querySelector("input").getAttribute("data-xsd2html2xml-primitive") === "date") {
                    element.querySelector("input").setAttribute("value", convertToLocalDate(value));
                }
        ...
        var parseNode = function (node, element) {
            ...
            // console.log("0. "+(node.childNodes.length === 1 && node.childNodes[0].nodeType === Node.TEXT_NODE))
            ...
            if (node.childNodes.length === 1 && node.childNodes[0].nodeType === Node.TEXT_NODE) {
                ...
                if (element.querySelectorAll("[data-xsd2html2xml-xpath='".concat(element.getAttribute("data-xsd2html2xml-xpath")).concat("']")).length > 0) {
                    // console.log("Attribute Nilai")
                    console.log(element.getAttribute("data-xsd2html2xml-xpath") + ' val ' + node.childNodes[0].nodeValue)
                    ...
                    // console.log("Attribute Nilai2")
                    // console.log("1 "+element.getAttribute("data-xsd2html2xml-xpath") + ' val ' + node.childNodes[0].nodeValue)
                ...
                for (var i = 0; i < node.childNodes.length; i++) {
                    ...
                    if (childNode.nodeType === Node.ELEMENT_NODE) {
                        ...
                        // console.log(element.getAttribute("data-xsd2html2xml-xpath"))
                        ...
                        // console.log(childElement.parentElement.lastElementChild)
                        // console.log("last element child " + childElement.parentElement.lastElementChild.nodeName.toLowerCase())
                        ...
                        if (childElement.parentElement.lastElementChild.nodeName.toLowerCase() === "button") {
                            // console.log("3.1. "+childElement.parentElement.lastElementChild.innerHTML)
                            // console.log(childElement.parentElement.lastElementChild.getAttribute("id"))
                            ...
                            // console.log("3.2. "+childElement.parentElement.lastElementChild.innerHTML)
...
//                button.closest("section").lastElementChild.removeAttribute("disabled");
                button.closest("section").lastElementChild.style.display = "inline-block";
        ...
        var clickRemoveFarrasModifiedButton = function (button) {
            if ((button.closest("section").children.length - 2) == button.closest("section").lastElementChild.getAttribute("data-xsd2html2xml-min"))
                button.closest("section").lastElementChild.click();
