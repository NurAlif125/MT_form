...
$(document).ready(function () {
  let validator = $("#form1").validate({
    ...
    onfocusout: false,
    rules: mt320_content.rules,
    messages: mt320_content.messages,
...
$(document).ready(function () {
  ...
  if (
    $("#_160_of32h_sign").val() != "" ||
    $("#_161_of32h_currency").val() != "" ||
    $("#_162_of32h_amount").val() != ""
  ) {
  ...
  //OF38J_check
  if (
    $("#_220_of38j_number_of_days").val() != "" ||
    $("#_221_of38j_number").val() != ""
  ) {
  ...
  //MF82_a_d_j
  if (
    $("#_070_mf82a_party_identifier").val() != "" ||
    $("#_071_mf82a_identifier_code").val() != ""
  ) {
    ...
    $("#_073_mf82d_party_identifier").val() != "" ||
    $("#_074_mf82d_name_address").val() != ""
  ) {
  ...
  //MF87_a_d_j
  if (
    $("#_080_mf87a_party_identifier").val() != "" ||
    $("#_081_mf87a_identifier_code").val() != ""
  ) {
    ...
    $("#_083_mf87d_party_identifier").val() != "" ||
    $("#_084_mf87d_name_address").val() != ""
  ) {
  ...
  //OF83_a_d_j
  if (
    $("#_090_of83a_party_identifier").val() != "" ||
    $("#_091_of83a_identifier_code").val() != ""
  ) {
    ...
    $("#_093_of83d_party_identifier").val() != "" ||
    $("#_094_of83d_name_address").val() != ""
  ) {
  ...
  //OF53_a_d_j
  if (
    $("#_240_of53a_party_identifier").val() != "" ||
    $("#_241_of53a_identifier_code").val() != ""
  ) {
    ...
    $("#_243_of53d_party_identifier").val() != "" ||
    $("#_244_of53d_name_address").val() != ""
  ) {
  ...
  //OF86_a_d_j
  if (
    $("#_250_of86a_party_identifier").val() != "" ||
    $("#_251_of86a_identifier_code").val() != ""
  ) {
    ...
    $("#_253_of86d_party_identifier").val() != "" ||
    $("#_254_of86d_name_address").val() != ""
  ) {
  ...
  //OF56_a_d_j
  if (
    $("#_260_of56a_party_identifier").val() != "" ||
    $("#_261_of56a_identifier_code").val() != ""
  ) {
    ...
    $("#_263_of56d_party_identifier").val() != "" ||
    $("#_264_of56d_name_address").val() != ""
  ) {
  ...
  //MF57_a_d_j
  if (
    $("#_270_mf57a_party_identifier").val() != "" ||
    $("#_271_mf57a_identifier_code").val() != ""
  ) {
    ...
    $("#_273_mf57d_party_identifier").val() != "" ||
    $("#_274_mf57d_name_address").val() != ""
  ) {
  ...
  //OF58_a_d_j
  if (
    $("#_280_of58a_party_identifier").val() != "" ||
    $("#_281_of58a_identifier_code").val() != ""
  ) {
    ...
    $("#_283_of58d_party_identifier").val() != "" ||
    $("#_284_of58d_name_address").val() != ""
  ) {
  ...
  //OF53_a_d_j
  if (
    $("#_290_of53a_party_identifier").val() != "" ||
    $("#_291_of53a_identifier_code").val() != ""
  ) {
    ...
    $("#_293_of53d_party_identifier").val() != "" ||
    $("#_294_of53d_name_address").val() != ""
  ) {
  ...
  //OF86_a_d_j
  if (
    $("#_300_of86a_party_identifier").val() != "" ||
    $("#_301_of86a_identifier_code").val() != ""
  ) {
    ...
    $("#_303_of86d_party_identifier").val() != "" ||
    $("#_304_of86d_name_address").val() != ""
  ) {
  ...
  //OF56_a_d_j
  if (
    $("#_310_of56a_party_identifier").val() != "" ||
    $("#_311_of56a_identifier_code").val() != ""
  ) {
    ...
    $("#_313_of56d_party_identifier").val() != "" ||
    $("#_314_of56d_name_address").val() != ""
  ) {
  ...
  //MF57_a_d_j
  if (
    $("#_320_mf57a_party_identifier").val() != "" ||
    $("#_321_mf57a_identifier_code").val() != ""
  ) {
    ...
    $("#_323_mf57d_party_identifier").val() != "" ||
    $("#_324_mf57d_name_address").val() != ""
  ) {
  ...
  //OF58_a_d_j
  if (
    $("#_330_of58a_party_identifier").val() != "" ||
    $("#_331_of58a_identifier_code").val() != ""
  ) {
    ...
    $("#_333_of58d_party_identifier").val() != "" ||
    $("#_334_of58d_name_address").val() != ""
  ) {
  ...
  //MF57_a_d_j
  if (
    $("#_370_mf57a_party_identifier").val() != "" ||
    $("#_371_mf57a_identifier_code").val() != ""
  ) {
    ...
    $("#_373_mf57d_party_identifier").val() != "" ||
    $("#_374_mf57d_name_address").val() != ""
  ) {
  ...
  //of88_a_d_j
  if (
    $("#_390_of88a_party_identifier").val() != "" ||
    $("#_391_of88a_identifier_code").val() != ""
  ) {
    ...
    $("#_393_of88d_party_identifier").val() != "" ||
    $("#_394_of88d_name_and_address").val() != ""
  ) {
  ...
  if (
    $("#_371_mf57a_identifier_code").val() != "" ||
    $("#_374_mf57d_name_address").val() != "" ||
    $("#_375_mf57j_party_identification").val() != ""
  ) {
  ...
  if (
    $("#_391_of88a_identifier_code").val() != "" ||
    $("#_394_of88d_name_and_address").val() != "" ||
    $("#_395_of88j_party_identification").val() != ""
  ) {
