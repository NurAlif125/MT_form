    ...
    $(document).ready(function() {
        let validator = $("#form1").validate({
            ...
            rules: {
                ...
                _297_mf59f_details: "required",
                _299_mf59f_details: "required",
...
//        specialrate
        ...
        $("#div_of52a_").hide();
        $("#div_of52d_").hide();
        $("#_110_of52a1_party_identifier").attr("disabled", true);
        $("#_111_of52a1_identifier_code").attr("disabled", true);
        $("#_113_of52d1_party_identifier").attr("disabled", true);
        $("#_114_of52d1_name_address").attr("disabled", true);
        $("#type_of52_").change(function() {
            if ( $("#type_of52_").val() == "a"){
                $("#div_of52a_").show();
                $("#div_of52d_").hide();
                $("#_110_of52a1_party_identifier").attr("disabled", false);
                $("#_111_of52a1_identifier_code").attr("disabled", false);
                $("#_113_of52d1_party_identifier").attr("disabled", true);
                $("#_114_of52d1_name_address").attr("disabled", true);
                ...
                $("#_110_of52a1_party_identifier").attr("disabled", true);
                $("#_111_of52a1_identifier_code").attr("disabled", true);
                $("#_113_of52d1_party_identifier").attr("disabled", false);
                $("#_114_of52d1_name_address").attr("disabled", false);
            } else{
                $("#div_of52a_").hide();
                $("#div_of52d_").hide();
                $("#_110_of52a1_party_identifier").attr("disabled", true);
        ...
        $("#div_of56a_").hide();
        $("#div_of56d_").hide();
        $("#_160_of56a1_party_identifier").attr("disabled", true);
        $("#_161_of56a1_identifier_code").attr("disabled", true);
        $("#_164_of56d1_party_identifier").attr("disabled", true);
        $("#_165_of56d1_name_address").attr("disabled", true);
        $("#type_of56_").change(function() {
            if ( $("#type_of56_").val() == "a"){
                $("#div_of56a_").show();
                $("#div_of56d_").hide();
                $("#_160_of56a1_party_identifier").attr("disabled", false);
                $("#_161_of56a1_identifier_code").attr("disabled", false);
                $("#_164_of56d1_party_identifier").attr("disabled", true);
                $("#_165_of56d1_name_address").attr("disabled", true);
                ...
                $("#_160_of56a1_party_identifier").attr("disabled", true);
                $("#_161_of56a1_identifier_code").attr("disabled", true);
                $("#_164_of56d1_party_identifier").attr("disabled", false);
                $("#_165_of56d1_name_address").attr("disabled", false);
            } else{
                $("#div_of56a_").hide();
                $("#div_of56d_").hide();
                $("#_160_of56a1_party_identifier").attr("disabled", true);
        ...
        $("#div_of57b_").hide();
        $("#div_of57d_").hide();
        $("#_170_of57a1_party_identifier").attr("disabled", true);
        $("#_171_of57a1_identifier_code").attr("disabled", true);
        $("#_173_of57b1_party_identifier").attr("disabled", true);
        $("#_174_of57b1_location").attr("disabled", true);
        $("#_176_of57d1_party_identifier").attr("disabled", true);
        $("#_177_of57d1_name_address").attr("disabled", true);
        $("#type_of57_").change(function() {
            if ( $("#type_of57_").val() == "a"){
                $("#div_of57a_").show();
                $("#div_of57b_").hide();
                $("#div_of57d_").hide();
                $("#_170_of57a1_party_identifier").attr("disabled", false);
                $("#_171_of57a1_identifier_code").attr("disabled", false);
                $("#_173_of57b1_party_identifier").attr("disabled", true);
                $("#_174_of57b1_location").attr("disabled", true);
                $("#_176_of57d1_party_identifier").attr("disabled", true);
                $("#_177_of57d1_name_address").attr("disabled", true);
                ...
                $("#_170_of57a1_party_identifier").attr("disabled", true);
                $("#_171_of57a1_identifier_code").attr("disabled", true);
                $("#_173_of57b1_party_identifier").attr("disabled", false);
                $("#_174_of57b1_location").attr("disabled", false);
                $("#_176_of57d1_party_identifier").attr("disabled", true);
                $("#_177_of57d1_name_address").attr("disabled", true);
                ...
                $("#_173_of57b1_party_identifier").attr("disabled", true);
                $("#_174_of57b1_location").attr("disabled", true);
                $("#_176_of57d1_party_identifier").attr("disabled", false);
                $("#_177_of57d1_name_address").attr("disabled", false);
            } else{
                $("#div_of57a_").hide();
                $("#div_of57b_").hide();
                $("#div_of57d_").hide();
...
//        of52a seq B
        $("#div_of52a_2").hide();
        $("#div_of52d_2").hide();
        $("#_260_of52a2_party_identifier").attr("disabled", true);
        $("#_261_of52a2_identifier_code").attr("disabled", true);
        $("#_263_of52d2_party_identifier").attr("disabled", true);
        $("#_264_of52d2_name_address").attr("disabled", true);
        $("#type_of52_2").change(function() {
            if ( $("#type_of52_2").val() == "a"){
                $("#div_of52a_2").show();
                $("#div_of52d_2").hide();
                $("#_260_of52a2_party_identifier").attr("disabled", false);
                $("#_261_of52a2_identifier_code").attr("disabled", false);
                $("#_263_of52d2_party_identifier").attr("disabled", true);
                $("#_264_of52d2_name_address").attr("disabled", true);
                ...
                $("#_260_of52a2_party_identifier").attr("disabled", true);
                $("#_261_of52a2_identifier_code").attr("disabled", true);
                $("#_263_of52d2_party_identifier").attr("disabled", false);
                $("#_264_of52d2_name_address").attr("disabled", false);
            } else{
                $("#div_of52a_2").hide();
                $("#div_of52d_2").hide();
                $("#_260_of52a2_party_identifier").attr("disabled", true);
	...
	$("#div_of56c_2").hide();
        $("#div_of56d_2").hide();
        $("#_270_of56a2_party_identifier").attr("disabled", true);
        $("#_271_of56a2_identifier_code").attr("disabled", true);
	$("#_273_of56c_party_identifier").attr("disabled", true);
        $("#_274_of56d2_party_identifier").attr("disabled", true);
        $("#_275_of56d2_name_address").attr("disabled", true);
        $("#type_of56_2").change(function() {
            if ( $("#type_of56_2").val() == "a"){
                $("#div_of56a_2").show();
                $("#div_of56c_2").hide();
                $("#div_of56d_2").hide();
                $("#_270_of56a2_party_identifier").attr("disabled", false);
                $("#_271_of56a2_identifier_code").attr("disabled", false);
                $("#_273_of56c_party_identifier").attr("disabled", true);
                $("#_274_of56d2_party_identifier").attr("disabled", true);
                $("#_275_of56d2_name_address").attr("disabled", true);
                ...
                $("#_271_of56a2_identifier_code").attr("disabled", true);
                $("#_273_of56c_party_identifier").attr("disabled", true);
                $("#_274_of56d2_party_identifier").attr("disabled", false);
                $("#_275_of56d2_name_address").attr("disabled", false);
            } else{
                $("#div_of56a_2").hide();
                $("#div_of56c_2").hide();
                $("#div_of56d_2").hide();
        ...
        $("#div_of57c_2").hide();
        $("#div_of57d_2").hide();
        $("#_280_of57a2_party_identifier").attr("disabled", true);
        $("#_281_of57a2_identifier_code").attr("disabled", true);
        $("#_283_of57b2_party_identifier").attr("disabled", true);
        $("#_284_of57b2_location").attr("disabled", true);
        $("#_285_of57c_party_identifier").attr("disabled", true);
        $("#_286_of57d2_party_identifier").attr("disabled", true);
        $("#_287_of57d2_name_address").attr("disabled", true);
        $("#type_of57_2").change(function () {
            if ($("#type_of57_2").val() == "a") {
                ...
                $("#div_of57c_2").hide();
                $("#div_of57d_2").hide();
                $("#_280_of57a2_party_identifier").attr("disabled", false);
                $("#_281_of57a2_identifier_code").attr("disabled", false);
                $("#_283_of57b2_party_identifier").attr("disabled", true);
                $("#_284_of57b2_location").attr("disabled", true);
                $("#_285_of57c_party_identifier").attr("disabled", true);
                $("#_286_of57d2_party_identifier").attr("disabled", true);
                ...
                $("#_280_of57a2_party_identifier").attr("disabled", true);
                $("#_281_of57a2_identifier_code").attr("disabled", true);
                $("#_283_of57b2_party_identifier").attr("disabled", false);
                $("#_284_of57b2_location").attr("disabled", false);
                $("#_285_of57c_party_identifier").attr("disabled", true);
                $("#_286_of57d2_party_identifier").attr("disabled", true);
                $("#_287_of57d2_name_address").attr("disabled", true);
                ...
                $("#_284_of57b2_location").attr("disabled", true);
                $("#_285_of57c_party_identifier").attr("disabled", true);
                $("#_286_of57d2_party_identifier").attr("disabled", false);
                $("#_287_of57d2_name_address").attr("disabled", false);
            } else {
                $("#div_of57a_2").hide();
                $("#div_of57b_2").hide();
                $("#div_of57c_2").hide();
...
// rule view 
    ...
    $(document).ready(function(){
        ...
        //of52_a_d
        if ($("#_110_of52a1_party_identifier").val() != "" || $("#_111_of52a1_identifier_code").val() != ""){
            ...
            $("#_113_of52d1_party_identifier").attr("disabled", true);
            $("#_114_of52d1_name_address").attr("disabled", true);
        } else if ($("#_113_of52d1_party_identifier").val() != "" || $("#_114_of52d1_name_address").val() != ""){
        ...
        //of56_a_d
        if ($("#_160_of56a1_party_identifier").val() != "" || $("#_161_of56a1_identifier_code").val() != ""){
            ...
            $("#_164_of56d1_party_identifier").attr("disabled", true);
            $("#_165_of56d1_name_address").attr("disabled", true);
        } else if ($("#_164_of56d1_party_identifier").val() != "" || $("#_165_of56d1_name_address").val() != ""){
        ...
        //of57_a_b_d
        if ($("#_170_of57a1_party_identifier").val() != "" || $("#_171_of57a1_identifier_code").val() != ""){
            ...
            $("#_176_of57d1_party_identifier").attr("disabled", true);
            $("#_177_of57d1_name_address").attr("disabled", true);
        } else if ($("#_173_of57b1_party_identifier").val() != "" || $("#_174_of57b1_location").val() != ""){
            ...
            $("#_176_of57d1_party_identifier").attr("disabled", true);
            $("#_177_of57d1_name_address").attr("disabled", true);
        } else if ($("#_176_of57d1_party_identifier").val() != "" || $("#_177_of57d1_name_address").val() != ""){
...
//        OF52 sequence B
        if ($("#_260_of52a2_party_identifier").val() != "" || $("#_261_of52a2_identifier_code").val() != ""){
            ...
            $("#_263_of52d2_party_identifier").attr("disabled", true);
            $("#_264_of52d2_name_address").attr("disabled", true);
        } else if ($("#_263_of52d2_party_identifier").val() != "" || $("#_264_of52d2_name_address").val() != ""){
        ...
        //OF56 sequence B
        if ($("#_270_of56a2_party_identifier").val() != "" || $("#_271_of56a2_identifier_code").val() != "") {
            ...
            $("#_274_of56d2_party_identifier").attr("disabled", true);
            $("#_275_of56d2_name_address").attr("disabled", true);
        } else if ($("#_274_of56d2_party_identifier").val() != "" || $("#_275_of56d2_name_address").val() != "") {
        ...
        //of57_a_b_c_d sequence B
        if ($("#_280_of57a2_party_identifier").val() != "" || $("#_281_of57a2_identifier_code").val() != "") {
            ...
            $("#_286_of57d2_party_identifier").attr("disabled", true);
            $("#_287_of57d2_name_address").attr("disabled", true);
        } else if ($("#_283_of57b2_party_identifier").val() != "" || $("#_284_of57b2_location").val() != "") {
            ...
            $("#_286_of57d2_party_identifier").attr("disabled", true);
            $("#_287_of57d2_name_address").attr("disabled", true);
        } else if ($("#_286_of57d2_party_identifier").val() != "" || $("#_287_of57d2_name_address").val() != "") {
