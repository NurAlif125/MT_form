...
let daftar_div = { mf82: ["", "a", "d", "j"], "of53#b2": ["", "a", "d", "j"] };

const selectionBoxToggle = (
    field,
    option,
    isHidden,
    sequence,
...
$(document).ready(function () {
    ...
    for (const div_key in daftar_div) {
        // Generic View
        let val_list = daftar_div[div_key];
        ...
        console.log("KEY:" + key + seq);

        val_list.forEach((opt) => {
            let isFilled = false;
            ...
            if (isFilled) {
                console.log("SEL OPT:" + key + opt + seq);
    ...
    */
    ...
    $("#_098_of77h_date").attr("disabled", true);
    ...
    $("#type_date_version_checkbox").click(function () {
        if ($("#type_date_version_checkbox").is(":checked")) {
            ...
            $("#_098_of77h_date").attr("disabled", false);
    ...
    */
    ...
    //check_of30u
    $("#check_of30u").hide();
    $("#_105_of30u_valuation_date").attr("disabled", true);
    $("#valuation_date_checkbox").click(function () {
        if ($("#valuation_date_checkbox").is(":checked")) {
            $("#check_of30u").show();
            $("#_105_of30u_valuation_date").attr("disabled", false);
        } else {
            $("#check_of30u").hide();
            $("#_105_of30u_valuation_date").attr("disabled", true);
        }
...
$(document).ready(function () {
    ...
    */
    ...
    //end of the line
    //check_of30u
    if ($("#_105_of30u_valuation_date").val() != "") {
