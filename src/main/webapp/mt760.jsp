                        ...
                        <div id="view2" class="tabcontent">
                            ...
                            <h2 class="header-title">Mandatory Sequence B Undertaking Details</h2>
                                ...
                                <div class="form-row"><span class="label_body">MF32B</span><span class="label"><a style="color:red;text-decoration:none">*</a>Currency</span>
                                    <input type="text" name="_210_mf32b_currency" id="_210_mf32b_currency" maxlength="3" class="mandatory" onkeypress="return textonly(event)" maxlength="3" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase();" input_type="MF32B Undertaking Amount" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_210_mf32b_currency'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <!--amount-->
                            ...
                            <div id="check_seq_c">
                                ...
                                <!--currency-->
                                <div class="form-row"><span class="label_body">MF32B</span><span class="label"><a style="color:red;text-decoration:none">*</a>Currency</span>
                                    <input type="text" name="_520_mf32b_currency" id="_520_mf32b_currency" onkeypress="return textonly(event)" maxlength="3" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase();" class="mandatory" input_type="MF32B Undertaking Amount" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_520_mf32b_currency'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                                </div>
                                <!--amount-->
                                <div class="form-row"><span class="label_body">&nbsp;</span><span class="label"><a style="color:red;text-decoration:none">*</a>Amount</span>                             
                                ...
                                <!--OF78 Automatic Extension Non-Extension Notification-->
                                <div class="form-row"><span class="label_body">OF78</span><span class="label">Automatic Extension Non-Extension Notification</span>
                                    <textarea onkeypress="avoidSplChars(event)" cols="65" rows="12" maxlength="780" style="resize:none;" name="_630_of78_automatic_extension_non_extension_notification" id="_630_of78_automatic_extension_non_extension_notification" ><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_630_of78_automatic_extension_non_extension_notification'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                                </div>
                                <hr/>
