                ...
                <div style="width: 100%; margin: 0 auto; font: 0.85em arial;">
                    ...
                    <div class="tabcontents">
                        ...
                        <div id="view2" class="tabcontent">
                            <div class="form-row">
                                <textarea onkeypress="avoidSplChars(event)" cols="65" rows="100" class="mandatory" style="height: 250px" name="_000_body_msg" id="_000_body_msg"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_000_body_msg'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                            </div>
                        </div>
