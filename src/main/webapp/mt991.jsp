...
<div id="isi">
    <c:forEach var="item" items="${role}">
        <c:if test="${item == 'MT:991'}">
            <div id="judul">MT 991 Request for Payment of Charges, Interest and Other Expenses</div>
            <form id="form1" name="form1" method="post" action="ServletControllerDataTransaksiOutgoing">
                <input name="messageType" id="messageType" type="hidden" value="991" />
