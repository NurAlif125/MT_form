...
<script>
    ...
    <% if (tanggal1 == null && tanggal2 == null) {
            //USD
            incCnfUsd = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "USD", "INC-CNF");
            incInvUsd = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "USD");
            incRtrUsd = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "USD");
            AckUsd = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "USD", "AUTH");
            //AUD
            incCnfAud = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "AUD", "INC-CNF");
            incInvAud = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "AUD");
            incRtrAud = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "AUD");
            AckAud = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "AUD", "AUTH");
            //SGD
            incCnfSgd = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "SGD", "INC-CNF");
            incInvSgd = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "SGD");
            incRtrSgd = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "SGD");
            AckSgd = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "SGD", "AUTH");
            //EUR
            incCnfEur = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "EUR", "INC-CNF");
            incInvEur = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "EUR");
            incRtrEur = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "EUR");
            AckEur = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "EUR", "AUTH");
            //JPY
            incCnfJpy = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "JPY", "INC-CNF");
            incInvJpy = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "JPY");
            incRtrJpy = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "JPY");
            AckJpy = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "JPY", "AUTH");
            //SAR
            incCnfSar = dbh.getDailyTrx("INC-STL", formatDate.format(date), formatDate.format(date), "SAR", "INC-CNF");
            incInvSar = dbh.getDailyTrxInvRtr("INC-INV", formatDate.format(date), formatDate.format(date), "SAR");
            incRtrSar = dbh.getDailyTrxInvRtr("INC-RTR", formatDate.format(date), formatDate.format(date), "SAR");
            AckSar = dbh.getDailyTrx("ACK", formatDate.format(date), formatDate.format(date), "SAR", "AUTH");

        } else {
            //USD
            incCnfUsd = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "USD", "INC-CNF");
            incInvUsd = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "USD");
            incRtrUsd = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "USD");
            AckUsd = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "USD", "AUTH");
            //AUD
            incCnfAud = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "AUD", "INC-CNF");
            incInvAud = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "AUD");
            incRtrAud = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "AUD");
            AckAud = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "AUD", "AUTH");
            //SGD
            incCnfSgd = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "SGD", "INC-CNF");
            incInvSgd = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "SGD");
            incRtrSgd = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "SGD");
            AckSgd = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "SGD", "AUTH");
            //EUR
            incCnfEur = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "EUR", "INC-CNF");
            incInvEur = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "EUR");
            incRtrEur = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "EUR");
            AckEur = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "EUR", "AUTH");
            //JPY
            incCnfJpy = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "JPY", "INC-CNF");
            incInvJpy = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "JPY");
            incRtrJpy = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "JPY");
            AckJpy = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "JPY", "AUTH");
            //JPY
            incCnfSar = dbh.getDailyTrx("INC-STL", tanggal1, tanggal2, "SAR", "INC-CNF");
            incInvSar = dbh.getDailyTrxInvRtr("INC-INV", tanggal1, tanggal2, "SAR");
            incRtrSar = dbh.getDailyTrxInvRtr("INC-RTR", tanggal1, tanggal2, "SAR");
            AckSar = dbh.getDailyTrx("ACK", tanggal1, tanggal2, "SAR", "AUTH");
