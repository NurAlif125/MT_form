...
<div id="isi">
    <c:forEach var="roleItem" items="${role}">
        <c:if test="${roleItem == 'FIAPATHCONF:LIST'}">
            ...
            <form id="form1" name="form1" method="post" action="SCFIAPath">
                ...
                <div class="form-row-action">
                    ...
                    <c:forEach var="roleItem2" items="${role}">
                        <c:if test="${!checkAdmin && (roleItem2 == 'ADM:MAKER' and empty fiaById.source)}">
                            <c:set var="checkAdmin" value="true" scope="page" />
                            <input type="submit" name="submit" id="submit" value="Save" />
                        </c:if>
                        <c:if test="${!checkAdmin && (roleItem2 == 'ADM:CHECKER' and not empty fiaById.source)}">
                            <c:set var="checkAdmin" value="true" scope="page" />
