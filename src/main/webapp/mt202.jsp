...
<script src="js/validate-mt/validate_rule_mt202.js"></script>
                            ...
                            <div class="form-row"><span class="label_body">MF20</span><span class="label"><a style="color:red; text-decoration:none">*</a>Transaction Reference Number</span>
                                <input type="text" class="mandatory" name="_010_mf20_sender_reference" id="_010_mf20_sender_reference" maxlength="16" input_type="MF20 Sender Reference" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_010_mf20_sender_reference'}"><c:out value="${item.detail}" /></c:if></c:forEach>"/>
                                    ...
                                    <div class="form-row"><span class="label_body">&nbsp;</span><span class="label"><a style="color:red; text-decoration:none">*</a>Currency Code</span>
                                        <input type="text" class="mandatory" name="_061_mf32a_currency" id="_061_mf32a_currency" onkeypress="return textonly(event)" maxlength="3" minlength="3" size="3" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase();" input_type="MF32a Currency" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_061_mf32a_currency'}"><c:out value="${item.detail}" /></c:if></c:forEach>"/>
                                    </div>
                                    <div class="form-row"><span class="label_body">&nbsp;</span><span class="label"><a style="color:red; text-decoration:none">*</a>Amount</span>
                                        <input type="text" class="mandatory" name="_062_mf32a_amount" id="_062_mf32a_amount" maxlength="15" onblur="checkZeroAmount(this.id); cek_koma(this);" input_type="MF32a Amount" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_062_mf32a_amount'}"><c:out value="${item.detail}" /></c:if></c:forEach>" onkeypress="return numbersonly(event, '_062_mf32a_amount');" ondrop="return false;" onpaste="return false;" />
                                ...
                                <div id="div_of57b_">
                                    ...
                                    <div class="form-row"><span class="label_body">MF58</span><span class="label"><a style="color:red; text-decoration:none">*</a>Beneficiary Institution</span>
                                        <select class="mandatory" id="type_of58_" name="type_of58_" input_type="MF58" location="Body" input_type="MF58 Beneficiary Institution" location="Body">
                                            <option value="">choose a type</option>
