<%-- 
    Document   : user_activity_report
    Created on : Nov 10, 2017, 11:37:30 AM
    Author     : AplDev2
--%>
...
<div id="isi">
    <c:forEach var="item" items="${role}">
        <c:if test="${item == 'MENU:REPORTING'}">
            <div id="judul">Audit Trail User Report</div>
            <form id="form1" name="form1" method="post" action="SCPrintUserActivity" target="_blank">
