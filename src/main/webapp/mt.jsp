    ...
    <form id="form1" class="form-mx" name="form1" method="post" action="#">
        ...
        <div id="content-mt-passthrough">
            ...
            <div class="tabcontents">
                <div id="view1" class="tabcontent">
                    <div class="form-row">
                        <div class="form-cols">
                            <h1>MT</h1>
                            <div class="p-3 bg-body rounded" id="value-mt-passthrough" >
                                <input type="hidden" name="mxview2" id="mxview2" value="<c:out value="${textById.final_mt}"/>" />
                                <div class="scrl editor-passthrough" id="editor">
                                </div>
                            </div> 
                        </div>
                    </div>
            ...
            <div id="view2" class="tabcontent">
                <div class="form-row" id="status-passthrough"><span class="label"></span>
