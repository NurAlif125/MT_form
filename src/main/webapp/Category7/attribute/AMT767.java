...
public class AMT767 {
    ...
    public MT767 getAtributeMT767() {
        ...
        data.setOf32b2(prop.getProperty("of32b"));
        data.setOf33b2(prop.getProperty("of33b"));
        data.setOf23b2(prop.getProperty("of23b"));
        data.setOf31e2(prop.getProperty("of31e"));
        data.setOf35g2(prop.getProperty("of35g"));
        data.setOf59(prop.getProperty("of59"));
        data.setOf77l(prop.getProperty("of77l"));
        data.setOf24e2(prop.getProperty("of24e"));
        data.setOf24g2(prop.getProperty("of24g"));
        return data;
    }
}
