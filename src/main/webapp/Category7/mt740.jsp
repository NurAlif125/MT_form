            ...
            <div class="form-body tabcontents">
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row"><span class="label_body">OF31D</span><span class="label">Date and Place of Expiry</span>
                            <input type="text" name="_040_of31d_date_of_expiry" id="_040_of31d_date_of_expiry" maxlength="6" placeholder="YYMMDD" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_040_of31d_date_of_expiry'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                            <input type="text" name="_041_of31d_place_of_expiry" id="_041_of31d_place_of_expiry" maxlength="29" placeholder="Place" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_041_of31d_place_of_expiry'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF58a</span><span class="label">Negotiating Bank</span>
                            <select id="_050_of58a_negotiating_bank" name="_050_of58a_negotiating_bank">
                                ...
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_050_of58a_negotiating_bank'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (Identifier Code)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_050_of58a_negotiating_bank'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row" id="wrap_051_of58a_party_identifier" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Party Identifier</span>
                            <input type="text" id="_051_of58a_party_identifier" name="_051_of58a_party_identifier" maxlength="34" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_051_of58a_party_identifier'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_052_of58a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_052_of58a_identifier_code" name="_052_of58a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_052_of58a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_053_of58a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_053_of58a_name_address" name="_053_of58a_name_address" rows="3" maxlength="140" ><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_053_of58a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">MF41a</span><span class="label"><a style="color:red;text-decoration:none">*</a>Available With ... By ...</span>
                            <select id="_100_mf41a_available_with_by" name="_100_mf41a_available_with_by" class="mandatory">
                                <option value="">choose a type</option>
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_100_mf41a_available_with_by'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (Identifier Code)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_100_mf41a_available_with_by'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row" id="wrap_101_mf41a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_101_mf41a_identifier_code" name="_101_mf41a_identifier_code" maxlength="11" input_type="MF41a Identifier Code" location="Body" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_101_mf41a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_102_mf41a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_102_mf41a_name_address" name="_102_mf41a_name_address" rows="3" maxlength="140" input_type="MF41a Name and Address" location="Body"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_102_mf41a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row" id="wrap_103_mf41a_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Code</span>
                            <select id="_103_mf41a_code" name="_103_mf41a_code" input_type="MF41a Code" location="Body">
                                <option value="">choose a type</option>
                                <option value="BY ACCEPTANCE" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_103_mf41a_code'}"><c:if test="${item.detail=='BY ACCEPTANCE'}"> selected="true" </c:if></c:if></c:forEach>>BY ACCEPTANCE</option>
                                <option value="BY DEF PAYMENT" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_103_mf41a_code'}"><c:if test="${item.detail=='BY DEF PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY DEF PAYMENT</option>
                                <option value="BY MIXED PYMT" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_103_mf41a_code'}"><c:if test="${item.detail=='BY MIXED PYMT'}"> selected="true" </c:if></c:if></c:forEach>>BY MIXED PYMT</option>
                                <option value="BY NEGOTIATION" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_103_mf41a_code'}"><c:if test="${item.detail=='BY NEGOTIATION'}"> selected="true" </c:if></c:if></c:forEach>>BY NEGOTIATION</option>
                                <option value="BY PAYMENT" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_103_mf41a_code'}"><c:if test="${item.detail=='BY PAYMENT'}"> selected="true" </c:if></c:if></c:forEach>>BY PAYMENT</option>
                            </select>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF42a</span><span class="label">Drawee</span>
                            <select id="_120_of42a_drawee" name="_120_of42a_drawee">
                                <option value="">choose a type</option>
                                <option value="A" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_120_of42a_drawee'}"><c:if test="${item.detail=='A'}"> selected="true" </c:if></c:if></c:forEach>>Option A (Identifier Code)</option>
                                <option value="D" <c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_120_of42a_drawee'}"><c:if test="${item.detail=='D'}"> selected="true" </c:if></c:if></c:forEach>>Option D (Name &amp; Address)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-row" id="wrap_121_of42a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_121_of42a_identifier_code" name="_121_of42a_identifier_code" maxlength="11" value="<c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_121_of42a_identifier_code'}"><c:out value="${item.detail}" /></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_122_of42a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_122_of42a_name_address" name="_122_of42a_name_address" rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName=='_122_of42a_name_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
