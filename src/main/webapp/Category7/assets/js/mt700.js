...
function handle51aOption() {
    const opt = document.getElementById("_080_of51a_applicant_bank").value;
...
function handle41aOption() {
    const opt = document.getElementById("_140_mf41a_available_with_by").value;
...
function handle42aOption() {
    const opt = document.getElementById("_160_of42a_drawee").value;
...
function handle58aOption() {
    const opt = document.getElementById("_350_of58a_requested_confirmation_party").value;
...
function handle53aOption() {
    const opt = document.getElementById("_360_of53a_reimbursing_bank").value;
...
function handle57aOption() {
    const opt = document.getElementById("_380_of57a_advise_through_bank").value;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    bindDateField("_250_of44c_latest_date_of_shipment");     
    ...
    const el51a = document.getElementById("_080_of51a_applicant_bank");
    if (el51a) {
        el51a.addEventListener("change", handle51aOption);
        handle51aOption();
    }

    const el41a = document.getElementById("_140_mf41a_available_with_by");
    if (el41a) {
        el41a.addEventListener("change", handle41aOption);
        handle41aOption();
    }

    const el42a = document.getElementById("_160_of42a_drawee");
    if (el42a) {
        el42a.addEventListener("change", handle42aOption);
        handle42aOption();
    }

    const el58a = document.getElementById("_350_of58a_requested_confirmation_party");
    if (el58a) {
        el58a.addEventListener("change", handle58aOption);
        handle58aOption();
    }

    const el53a = document.getElementById("_360_of53a_reimbursing_bank");
    if (el53a) {
        el53a.addEventListener("change", handle53aOption);
        handle53aOption();
    }

    const el57a = document.getElementById("_380_of57a_advise_through_bank");
    if (el57a) {
