...
function validateMT708() {
  ...
  if (!validateStructuredField708("_070_of45b_description_of_goods_and_or_services")) return false;
  ...
  if (!validateStructuredField708("_100_of49m_special_payment_conditions_for_beneficiary")) return false;
  if (!validateStructuredField708("_110_of49n_special_payment_conditions_for_bank_only")) return false;
