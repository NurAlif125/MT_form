            ...
            <div class="form-body tabcontents">
                <div id="view2" class="tabcontent active">
                        ...
                        <div class="form-row"><span class="label_body">MF20</span><span class="label"><a style="color:red;text-decoration:none">*</a>Sender's Reference</span>
                            <input type="text" name="_030_mf20_sender_reference" id="_030_mf20_sender_reference"
                                class="mandatory" maxlength="16"
                                onkeypress="avoidSplChars(event)"
                                value="<c:forEach var='item' items='${tags}'>
                                           <c:if test='${item.tagName eq "_030_mf20_sender_reference"}'>
                                        <c:out value='${item.detail}'/>
                                    </c:if>
                                </c:forEach>"/>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF23</span><span class="label">Reference to Pre-Advice</span>
                            <input type="text" name="_050_of23_reference_to_preadvice" 
                                   id="_050_of23_reference_to_preadvice"
                                   maxlength="16"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_050_of23_reference_to_preadvice"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">MF31C</span><span class="label"><a style="color:red;text-decoration:none">*</a>Date of Issue</span>
                            <input type="text" name="_060_mf31c_date_of_issue" 
                                   id="_060_mf31c_date_of_issue"
                                   class="mandatory" maxlength="6" placeholder="YYMMDD"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_060_mf31c_date_of_issue"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">MF40E</span><span class="label"><a style="color:red;text-decoration:none">*</a>Applicable Rules</span>
                            <select name="_070_mf40e_applicable_rules" 
                                    id="_070_mf40e_applicable_rules"
                                    class="mandatory">
                                <option value="">choose a type</option>
                                <option value="UCP LATEST VERSION"
                                    <c:forEach var="item" items="${tags}">
                                        <c:if test="${item.tagName eq '_070_mf40e_applicable_rules' and item.detail eq 'UCP LATEST VERSION'}">selected</c:if>
                                    </c:forEach>>UCP LATEST VERSION</option>
                                <option value="UCPURR LATEST VERSION"
                                    <c:forEach var="item" items="${tags}">
                                        <c:if test="${item.tagName eq '_070_mf40e_applicable_rules' and item.detail eq 'UCPURR LATEST VERSION'}">selected</c:if>
                                    </c:forEach>>UCPURR LATEST VERSION</option>
                                <option value="EUCP LATEST VERSION"
                                    <c:forEach var="item" items="${tags}">
                                        <c:if test="${item.tagName eq '_070_mf40e_applicable_rules' and item.detail eq 'EUCP LATEST VERSION'}">selected</c:if>
                                    </c:forEach>>EUCP LATEST VERSION</option>
                                <option value="EUCPURR LATEST VERSION"
                                    <c:forEach var="item" items="${tags}">
                                        <c:if test="${item.tagName eq '_070_mf40e_applicable_rules' and item.detail eq 'EUCPURR LATEST VERSION'}">selected</c:if>
                                    </c:forEach>>EUCPURR LATEST VERSION</option>
                                <option value="OTHR"
                                    <c:forEach var="item" items="${tags}">
                                        <c:if test="${item.tagName eq '_070_mf40e_applicable_rules' and item.detail eq 'OTHR'}">selected</c:if>
                        ...
                        <div id="div_070_mf40e_narrative" style="display:none;">
                            <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Narrative (if OTHR)</span>
                                <textarea name="_071_mf40e_narrative" 
                                          id="_071_mf40e_narrative"
                                          rows="2" maxlength="35"><c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_071_mf40e_narrative'}">
                                        <c:out value="${item.detail}" />
                                    </c:if>
                                </c:forEach></textarea>
                            </div>
                        ...
                        <div class="form-row"><span class="label_body">MF31D</span><span class="label"><a style="color:red;text-decoration:none">*</a>Date and Place of Expiry</span>
                            <input type="text" name="_080_mf31d_date_of_expiry"
                                   id="_080_mf31d_date_of_expiry"
                                   class="mandatory" maxlength="6"
                                   placeholder="YYMMDD"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_080_mf31d_date_of_expiry"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                            <input type="text" name="_081_mf31d_place_of_expiry"
                                   id="_081_mf31d_place_of_expiry"
                                   maxlength="29"
                                   placeholder="Place"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_081_mf31d_place_of_expiry"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_091_of52a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_091_of52a_identifier_code" name="_091_of52a_identifier_code"
                                   maxlength="11"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_091_of52a_identifier_code"}'>
                                                  <c:out value='${item.detail}'/>
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_092_of52a_name_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name &amp; Address</span>
                            <textarea id="_092_of52a_name_address" name="_092_of52a_name_address"
                                      rows="3" maxlength="140"><c:forEach var="item" items="${tags}">
                                <c:if test="${item.tagName eq '_092_of52a_name_address'}">
                                    <c:out value="${item.detail}" />
                                </c:if>
                            </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF50B</span><span class="label">Non-Bank Issuer</span>
                            <textarea name="_100_of50b_non_bank_issuer" id="_100_of50b_non_bank_issuer"
                                      rows="3" maxlength="140"><c:forEach var="item" items="${tags}">
                                <c:if test="${item.tagName eq '_100_of50b_non_bank_issuer'}">
                                    <c:out value="${item.detail}"/>
                                </c:if>
                            </c:forEach></textarea>
                        </div>
                        ...
                        <div id="div_110_of51a_A" style="display:none;">
                            <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                                <input type="text" name="_111_of51a_bic"
                                       id="_111_of51a_bic"
                                       maxlength="11"
                                       value="<c:forEach var='item' items='${tags}'>
                                                  <c:if test='${item.tagName eq "_111_of51a_bic"}'>
                                                      <c:out value='${item.detail}' />
                                                  </c:if>
                                              </c:forEach>" />
                            </div>
                        ...
                        <div id="div_110_of51a_D" style="display:none;">
                            <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                                <textarea name="_112_of51a_name_address"
                                          id="_112_of51a_name_address"
                                          rows="3" maxlength="140"><c:forEach var='item' items='${tags}'>
                                    <c:if test='${item.tagName eq "_112_of51a_name_address"}'>
                                        <c:out value='${item.detail}' />
                                    </c:if>
                                </c:forEach></textarea>
                            </div>
                        ...
                        <div class="form-row"><span class="label_body">MF50</span><span class="label"><a style="color:red;text-decoration:none">*</a>Applicant</span>
                            <textarea name="_120_mf50_applicant"
                                      id="_120_mf50_applicant"
                                      class="mandatory"
                                      rows="4" maxlength="140"><c:forEach var='item' items='${tags}'>
                                          <c:if test='${item.tagName eq "_120_mf50_applicant"}'>
                                              <c:out value='${item.detail}' />
                                          </c:if>
                                      </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Account</span>
                            <input type="text" name="_130_mf59_account"
                                   id="_130_mf59_account"
                                   maxlength="34"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_130_mf59_account"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span>  <span class="label">Name & Address</span>
                            <textarea name="_131_mf59_name_address"
                                      id="_131_mf59_name_address"
                                      class="mandatory"
                                      rows="4" maxlength="140"><c:forEach var='item' items='${tags}'>
                                          <c:if test='${item.tagName eq "_131_mf59_name_address"}'>
                                              <c:out value='${item.detail}' />
                                          </c:if>
                                      </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">MF32B</span><span class="label"><a style="color:red;text-decoration:none">*</a>Currency Code, Amount</span>
                        </div>
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Currency</span>
                            <input type="text" name="_140_mf32b_currency" id="_140_mf32b_currency"
                                   ...
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_140_mf32b_currency"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">Amount</span>
                            <input type="text" name="_141_mf32b_amount" id="_141_mf32b_amount"
                                   ...
                                   oninput="this.value = this.value.toUpperCase();"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_141_mf32b_amount"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>"
                                   onkeypress="return numbersonly(event, '_140_mf32b_currency');" />
                        ...
                        <div class="form-row"><span class="label_body">OF39A</span><span class="label">Percentage Credit Amount Tolerance</span>
                            <input type="text" name="_150_of39a_tolerance_plus"
                                   id="_150_of39a_tolerance_plus"
                                   maxlength="2"
                                   placeholder="Plus %"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_150_of39a_tolerance_plus"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                            <input type="text" name="_151_of39a_tolerance_minus"
                                   id="_151_of39a_tolerance_minus"
                                   maxlength="2"
                                   placeholder="Minus %"
                                   value="<c:forEach var='item' items='${tags}'>
                                              <c:if test='${item.tagName eq "_151_of39a_tolerance_minus"}'>
                                                  <c:out value='${item.detail}' />
                                              </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_171_mf41a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_171_mf41a_identifier_code" name="_171_mf41a_identifier_code"
                                   maxlength="11"
                                   value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_171_mf41a_identifier_code"}'><c:out value='${item.detail}'/></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_172_mf41d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_172_mf41d_name_and_address" name="_172_mf41d_name_and_address"
                                      rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName eq '_172_mf41d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>

                        <div class="form-row"><span class="label_body">&nbsp;</span><span class="label">By</span>
                            <select id="_173_mf41a_by" name="_173_mf41a_by">
                                <option value="">choose a type</option>
                        ...
                        <div class="form-row" id="wrap_191_of42a_identifier_code" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Identifier Code (BIC)</span>
                            <input type="text" id="_191_of42a_identifier_code" name="_191_of42a_identifier_code"
                                   maxlength="11"
                                   value="<c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_191_of42a_identifier_code"}'><c:out value='${item.detail}'/></c:if></c:forEach>" />
                        </div>
                        ...
                        <div class="form-row" id="wrap_192_of42d_name_and_address" style="display:none;"><span class="label_body">&nbsp;</span><span class="label">Name & Address</span>
                            <textarea id="_192_of42d_name_and_address" name="_192_of42d_name_and_address"
                                      rows="3" maxlength="140"><c:forEach var="item" items="${tags}"><c:if test="${item.tagName eq '_192_of42d_name_and_address'}"><c:out value="${item.detail}" /></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF42P</span><span class="label">Negotiation/Deferred Payment Details</span>
                            <textarea name="_210_of42p_negotiation" id="_210_of42p_negotiation"
                                      rows="4" maxlength="140"><c:forEach var='item' items='${tags}'><c:if test='${item.tagName eq "_210_of42p_negotiation"}'><c:out value='${item.detail}'/></c:if></c:forEach></textarea>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF43P</span><span class="label">Partial Shipments</span>
                            <select name="_220_of43p_partial_shipments" id="_220_of43p_partial_shipments">
                                ...
                                <option value="ALLOWED" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_220_of43p_partial_shipments' and item.detail eq 'ALLOWED'}">selected</c:if>
                                </c:forEach>>ALLOWED</option>
                                <option value="CONDITIONAL" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_220_of43p_partial_shipments' and item.detail eq 'CONDITIONAL'}">selected</c:if>
                                </c:forEach>>CONDITIONAL</option>
                                <option value="NOT ALLOWED" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_220_of43p_partial_shipments' and item.detail eq 'NOT ALLOWED'}">selected</c:if>
                        ...
                        <div class="form-row"><span class="label_body">OF43T</span><span class="label">Transhipment</span>
                            <select name="_230_of43t_transhipment" id="_230_of43t_transhipment">
                                <option value="">choose a type</option>
                                <option value="ALLOWED" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_230_of43t_transhipment' and item.detail eq 'ALLOWED'}">selected</c:if>
                                </c:forEach>>ALLOWED</option>
                                <option value="CONDITIONAL" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_230_of43t_transhipment' and item.detail eq 'CONDITIONAL'}">selected</c:if>
                                </c:forEach>>CONDITIONAL</option>
                                <option value="NOT ALLOWED" <c:forEach var="item" items="${tags}">
                                    <c:if test="${item.tagName eq '_230_of43t_transhipment' and item.detail eq 'NOT ALLOWED'}">selected</c:if>
                                </c:forEach>>NOT ALLOWED</option>
                            </select>
                        </div>
                        <hr/>
                        ...
                        <div class="form-row"><span class="label_body">OF44D</span><span class="label">Shipment Period</span>
                            <textarea name="_290_of44d_shipment_period"
                                      id="_290_of44d_shipment_period"
                                      rows="3" maxlength="390"><c:forEach var='item' items='${tags}'>
                                <c:if test='${item.tagName eq "_290_of44d_shipment_period"}'>
                                    <c:out value='${item.detail}' />
                                </c:if>
                            </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF47A</span><span class="label">Additional Conditions</span>
                            <textarea name="_320_of47a_additional_conditions" id="_320_of47a_additional_conditions"
                                      rows="6" maxlength="6500"><c:forEach var="item" items="${tags}">
                                <c:if test="${item.tagName eq '_320_of47a_additional_conditions'}">
                                    <c:out value="${item.detail}" />
                                </c:if>
                            </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF71D</span><span class="label">Charges</span>
                            <textarea name="_350_of71d_charges"
                                      id="_350_of71d_charges"
                                      rows="6" maxlength="210"><c:forEach var='item' items='${tags}'>
                                <c:if test='${item.tagName eq "_350_of71d_charges"}'>
                                    <c:out value='${item.detail}' />
                                </c:if>
                            </c:forEach></textarea>
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF48</span><span class="label">Period for Presentation in Days</span>
                            <input type="text" name="_360_of48_days"
                                   id="_360_of48_days"
                                   maxlength="3"
                                   placeholder="Days"
                                   value="<c:forEach var='item' items='${tags}'>
                                             <c:if test='${item.tagName eq "_360_of48_days"}'>
                                                 <c:out value='${item.detail}' />
                                             </c:if>
                                          </c:forEach>" />
                            <input type="text" name="_361_of48_narrative"
                                   id="_361_of48_narrative"
                                   maxlength="35"
                                   placeholder="Narrative (optional)"
                                   value="<c:forEach var='item' items='${tags}'>
                                             <c:if test='${item.tagName eq "_361_of48_narrative"}'>
                                                 <c:out value='${item.detail}' />
                                             </c:if>
                                          </c:forEach>" />
                        </div>
                        ...
                        <div class="form-row"><span class="label_body">OF58a</span><span class="label">Requested Confirmation Party</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_381_of58a_bic" style="display:none;">
                                    <input type="text" name="_381_of58a_bic" id="_381_of58a_bic"
                                           maxlength="11" placeholder="BIC"
                                           value="<c:forEach var='item' items='${tags}'>
                                                      <c:if test='${item.tagName eq "_381_of58a_bic"}'>
                                                          <c:out value='${item.detail}' />
                                                      </c:if>
                                                  </c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_382_of58a_name_address" style="display:none;">
                                    <textarea name="_382_of58a_name_address" id="_382_of58a_name_address"
                                              rows="3" maxlength="140"><c:forEach var='item' items='${tags}'>
                                        <c:if test='${item.tagName eq "_382_of58a_name_address"}'>
                                            <c:out value='${item.detail}' />
                                        </c:if>
                                    </c:forEach></textarea>
                                </div>
                        ...
                        <div class="form-row"><span class="label_body">OF53a</span><span class="label">Reimbursing Bank</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_391_of53a_bic" style="display:none;">
                                    <input type="text" name="_391_of53a_bic" id="_391_of53a_bic"
                                           maxlength="11" placeholder="BIC"
                                           value="<c:forEach var='item' items='${tags}'>
                                                      <c:if test='${item.tagName eq "_391_of53a_bic"}'>
                                                          <c:out value='${item.detail}' />
                                                      </c:if>
                                                  </c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_392_of53a_name_address" style="display:none;">
                                    <textarea name="_392_of53a_name_address" id="_392_of53a_name_address"
                                              rows="3" maxlength="140"><c:forEach var='item' items='${tags}'>
                                        <c:if test='${item.tagName eq "_392_of53a_name_address"}'>
                                            <c:out value='${item.detail}' />
                                        </c:if>
                                    </c:forEach></textarea>
                                </div>
                        ...
                        <div class="form-row"><span class="label_body">OF57a</span><span class="label">'Advise Through' Bank</span>
                            <div class="mt-row">
                                ...
                                <div class="mt-col" id="wrap_421_of57a_bic" style="display:none;">
                                    <input type="text" name="_421_of57a_bic" id="_421_of57a_bic"
                                           maxlength="11" placeholder="BIC"
                                           value="<c:forEach var='item' items='${tags}'>
                                                      <c:if test='${item.tagName eq "_421_of57a_bic"}'>
                                                          <c:out value='${item.detail}' />
                                                      </c:if>
                                                  </c:forEach>" />
                                </div>
                                <div class="mt-col" id="wrap_422_of57a_location" style="display:none;">
                                    <input type="text" name="_422_of57a_location" id="_422_of57a_location"
                                           maxlength="35" placeholder="Location"
                                           value="<c:forEach var='item' items='${tags}'>
                                                      <c:if test='${item.tagName eq "_422_of57a_location"}'>
                                                          <c:out value='${item.detail}' />
                                                      </c:if>
                                                  </c:forEach>" />
                                </div>
                        ...
                        <div class="form-row"><span class="label_body">OF72Z</span><span class="label">Sender to Receiver Information</span>
                            <textarea name="_430_of72z_information"
                                      id="_430_of72z_information"
                                      rows="6" maxlength="210"><c:forEach var='item' items='${tags}'>
                                <c:if test='${item.tagName eq "_430_of72z_information"}'>
                                    <c:out value='${item.detail}' />
                                </c:if>
                            </c:forEach></textarea>
                        </div>
