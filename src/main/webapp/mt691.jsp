...
<c:forEach var="item" items="${role}">
    <c:if test="${item == 'MT:691'}">
        <div id="tabs">
            <!-- Tabs -->
            <h3>MT 691 Request for Payment of Charges, Interest and Other Expenses</h3>
            <form id="form1" name="form1" method="post" action="ServletControllerDataTransaksiOutgoing">
                <input name="messageType" id="messageType" type="hidden" value="691" />
                <ul>
